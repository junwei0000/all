...
import com.longcheng.volunteer.modular.home.commune.adapter.CommuneJoinTeamListAdapter;
...
public class CommuneJoinTeamListActivity extends BaseListActivity<CommuneContract.View, CommunePresenterImp<CommuneContract.View>> implements CommuneContract.View {
        ...
        join_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (teamList != null && teamList.size() > 0) {
                    mPresent.JoinCommune(user_id, group_id, teamList.get(position).getTeam_id());
                }
            }
        });
    }
    ...
    public void GetTeamListSuccess(CommuneListDataBean responseBean) {
        ...
        if (status_.equals("400")) {
            ...
            if (mEnergyAfterBean != null) {
                ...
                mAdapter = new CommuneJoinTeamListAdapter(mContext, teamList);
    ...
    public void JoinCommuneSuccess(EditListDataBean responseBean) {
        ...
        if (status_.equals("200")) {
            Intent intent = new Intent(mContext, CommuneMineActivity.class);
