...
import com.longcheng.volunteer.modular.helpwith.energy.adapter.ActionSelectAdapter;
import com.longcheng.volunteer.modular.helpwith.energy.adapter.SelectAdapter;
import com.longcheng.volunteer.modular.helpwith.energy.bean.ActionItemBean;
import com.longcheng.volunteer.modular.helpwith.energy.bean.ActionListDataBean;
import com.longcheng.volunteer.modular.helpwith.energy.bean.HelpEnergyAfterBean;
import com.longcheng.volunteer.modular.helpwith.energy.bean.HelpEnergyListDataBean;
import com.longcheng.volunteer.modular.helpwith.energy.bean.HelpItemBean;
import com.longcheng.volunteer.modular.helpwith.energydetail.activity.DetailActivity;
import com.longcheng.volunteer.modular.helpwith.energy.adapter.EngryListAdapter;
...
import com.longcheng.volunteer.wxapi.WXPayEntryActivity;
...
public class HelpWithEnergyActivity extends BaseListActivity<EnergyContract.View, EnergyPresenterImp<EnergyContract.View>> implements EnergyContract.View {
    ...
    private void showPopupWindow() {
        if (selectDialog == null) {
            ...
            gv_help = (MyGridView) selectDialog.findViewById(R.id.gv_help);
            gv_action = (MyGridView) selectDialog.findViewById(R.id.gv_action);
            TextView btn_reset = (TextView) selectDialog.findViewById(R.id.btn_reset);
            TextView btn_finish = (TextView) selectDialog.findViewById(R.id.btn_finish);
            setGVHelpLove();
            setGVHelpAction();
