...
public class UserRegistBusiness {
	...
	public interface GetRegistCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetRegistCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public UserRegistBusiness(Context mContext,
			HashMap<String, String> mhashmap, GetRegistCallback mGetDataCallback) {
	...
	private void getDate() {
		String path = Constans.REGISTSET;
