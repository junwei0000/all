 ...
 * 
 */
public class HaveThIconClearEditText extends EditText implements
	...
	public HaveThIconClearEditText(Context context) {
		this(context, null);
	}

	public HaveThIconClearEditText(Context context, AttributeSet attrs) {
