...
public class CustomCrashHandler implements UncaughtExceptionHandler {
	...
	private String SDCARD_ROOT = Environment.getExternalStorageDirectory()
			.toString();
	...
	private String savaInfoToSD(Context context, Throwable ex) {
		...
		if (Environment.getExternalStorageState().equals(
			...
			File dir = new File(SDCARD_ROOT + File.separator + "bestdo_log"
					+ File.separator);
			if (!dir.exists()) {
				dir.mkdir();
			}
		...
		// 写入手机内存
			...
			try {
				...
				phone_outStream = context.openFileOutput(fileName,
