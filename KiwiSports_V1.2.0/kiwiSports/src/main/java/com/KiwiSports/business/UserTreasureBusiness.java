 ...
 * @Description 类描述：
 */
public class UserTreasureBusiness {

	public interface GetTreasureCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetTreasureCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public UserTreasureBusiness(Context mContext,
			HashMap<String, String> mhashmap,
			GetTreasureCallback mGetDataCallback) {
	...
	private void getDate() {
		String path = Constants.USERTREASURE;
