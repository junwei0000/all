...
public class RecordDetailActivity extends BaseActivity {
    ...
    private void showCurrentPropertyValue() {
        ...
        freezeDuration = mRecordInfo.getFreezeDuration();
        ...
        } else if (sportindex.equals("1") || sportindex.equals("5")) {// 跑步
            for (int i = 0; i < mMpropertyList.size(); i++) {
                switch (i) {
                    case 0:
        ...
        RecordDetailPropertyAdapter mdate_propertyAdapter = new RecordDetailPropertyAdapter(
                this, mMpropertyList);
