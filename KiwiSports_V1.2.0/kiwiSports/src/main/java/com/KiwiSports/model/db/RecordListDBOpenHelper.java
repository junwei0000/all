...
public class RecordListDBOpenHelper {
    ...
    public void creatTableSQL() {
        ...
        sqlBuffer.append(pauseTimestamp + " INTEGER,");
    ...
    public boolean addTableInfo(RecordInfo mRecordInfo) {
        ...
        contentValues.put(pauseTimestamp, mRecordInfo.getPauseTimestamp());
    ...
    public ArrayList<RecordInfo> getHistoryDBList(
        ...
        try {
            ...
            String[] columns = {record_id, uid, posid, date_time, distanceTraveled, duration, verticalDistance
                    ...
                    , currentAltitude, averageMatchSpeed, averageSpeed, freezeDuration, pauseTimestamp, maxHoverDuration, totalHoverDuration
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    long _pauseTimestamp = cursor.getLong(cursor.getColumnIndex(pauseTimestamp));
                    ...
                    RecordInfo mRecordInfo = new RecordInfo(_record_id, _uid,
                            ...
                            _freezeDuration, _pauseTimestamp, _maxHoverDuration,
