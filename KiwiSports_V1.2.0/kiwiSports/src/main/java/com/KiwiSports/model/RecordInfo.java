...
public class RecordInfo {
    ...
    public RecordInfo(String record_id, String uid, String posid,
                      String date_time, double distanceTraveled, long duration,
                      String verticalDistance, String topSpeed, String dropTraveled,
                      String nSteps, String matchSpeed, String maxMatchSpeed,
                      String maxSlope, String maxAltitude, String currentAltitude,
                      String averageMatchSpeed, String averageSpeed, long freezeDuration,long pauseTimestamp,
                      String maxHoverDuration, String totalHoverDuration,
                      String lapCount, String wrestlingCount,
                      String cableCarQueuingDuration, String address, String minAltidue,
                      String calorie, String sportsType, String latitudeOffset,
                      String longitudeOffset, String upHillDistance,
                      String downHillDistance, String extendedField1,
                      String extendedField2, String extendedField3, String create_time,
                      String cstatus, String pos_name, String runStartTime, String runStartTimeTamp,
                      String minMatchSpeed, String currentTrackStatus) {
        super();
        ...
        this.runStartTimeTamp = runStartTimeTamp;
        this.currentTrackStatus = currentTrackStatus;
    }
    ...
    public void setRunStartTimeTamp(String runStartTimeTamp) {
        this.runStartTimeTamp = runStartTimeTamp;
    }
    ...
    public void setCurrentTrackStatus(String currentTrackStatus) {
        this.currentTrackStatus = currentTrackStatus;
    }

    public String getRunStartTimeTamp() {
        return runStartTimeTamp;
    }
    ...
    public String getMinMatchSpeed() {
        return minMatchSpeed;
    }

    public void setMinMatchSpeed(String minMatchSpeed) {
        this.minMatchSpeed = minMatchSpeed;
    }
