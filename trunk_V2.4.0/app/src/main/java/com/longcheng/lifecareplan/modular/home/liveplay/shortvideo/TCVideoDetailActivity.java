 ...
 */
public class TCVideoDetailActivity extends BaseActivityMVP<LivePushContract.View, LivePushPresenterImp<LivePushContract.View>> implements LivePushContract.View, ITXVodPlayListener {
    ...
    public static void skipVideoDetail(Activity mActivity) {
...
//                mCurrentPosition = position;
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public PlayerInfo instantiatePlayerInfo(int position, ImageButton record_preview_) {
            ...
            vodPlayer.setVodListener(TCVideoDetailActivity.this);
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            record_preview.setOnClickListener(TCVideoDetailActivity.this);
            frag_iv_dashuang.setOnClickListener(TCVideoDetailActivity.this);
            frag_layout_dianzan.setOnClickListener(TCVideoDetailActivity.this);
            frag_layout_comment.setOnClickListener(TCVideoDetailActivity.this);
            frag_layout_share.setOnClickListener(TCVideoDetailActivity.this);
            iv_avatar.setOnClickListener(TCVideoDetailActivity.this);
