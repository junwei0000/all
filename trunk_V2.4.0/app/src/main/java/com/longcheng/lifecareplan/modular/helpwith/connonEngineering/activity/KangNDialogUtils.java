...
public class KangNDialogUtils {
    ...
    public KangNDialogUtils(Activity context, Handler mHandler, int mHandlerID) {
    ...
    public void showPopupWindow() {
        if (selectDialog == null) {
            selectDialog = new MyDialog(context, R.style.dialog, R.layout.dialog_kangndetailhelpred);// 创建Dialog并设置样式主题
