...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.caililist.adapter.PionCailiListAdapter;
...
public abstract class PionCailiBaseOrderFrag extends BaseListFrag<PionCailiContract.View, PionCailiPresenterImp<PionCailiContract.View>> implements PionCailiContract.View {
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            String entrepreneurs_apply_rebate_id = (String) msg.obj;
            switch (msg.what) {
                case SUREPAY:
                    setDialog(entrepreneurs_apply_rebate_id, SUREPAY);
                    break;
            }
        }
    };
    ...
    public void setDialog(String entrepreneurs_apply_rebate_id, int type) {
