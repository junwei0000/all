...
//        public static final int TOTALSENDED_PACKETSIZE_INTWOSECOND = 44;    //两秒内上传数据总大小
    ...
    public LogViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.live_layout_item_log_info, parent, false);
...
//        updateValue(LogItem.AUDIO_CAPTURE_FPS, String.valueOf(alivcLivePushStatsInfo.getAudioCaptureFps()));
        ...
        updateValue(LogItem.VIDEO_ENCODE_MODE, alivcLivePushStatsInfo.getVideoEncodeMode() == AlivcEncodeModeEnum.Encode_MODE_HARD ? "Hardware encode" : "Software encode");
