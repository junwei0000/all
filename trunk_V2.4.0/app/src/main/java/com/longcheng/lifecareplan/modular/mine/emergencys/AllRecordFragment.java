...
public class AllRecordFragment extends BaseListFrag<CSRecordContract.View, CSRecordImp<CSRecordContract.View>> implements CSRecordContract.View, IActivityUpData {
...
//                }
                if (mAdapter == null) {
                    mAdapter = new CSRecordAdapter(mActivity, responseBean.getData(), getActivity(), 3);
    ...
    private void getData(int page) {
        mPresent.helpneed_customerList(user_id, 3, page, pageSize);
    }
