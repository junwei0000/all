...
public class MyAdapter extends BaseAdapterHelper<ItemBean> {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            item_layout_thumb = view.findViewById(R.id.item_layout_thumb);
            item_tv_sortnum = view.findViewById(R.id.item_tv_sortNum);
            ...
            item_tv_renci = view.findViewById(R.id.item_tv_renci);
