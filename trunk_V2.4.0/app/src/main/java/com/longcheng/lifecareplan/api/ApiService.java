...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.openorder.bean.PionOpenGMListDataBean;
...
public interface ApiService {
    ...
    @GET(Config.VERSION + "im/register")
    Observable<GetHomeInfoDataBean> getImToken(@Query("user_id") String user_id, @Query("token") String token);

    @GET(Config.VERSION + "im/getUserInfos")
    Observable<PionImListInfoDataBean> getIMUserInfos(@Query("user_id") String user_id,
    ...
    @GET(Config.VERSION + "im/checkCashInProgressOrder")
    Observable<PionImDataBean> checkCashInProgressOrder(@Query("user_id") String user_id,
                                                        @Query("check_user_id") String check_user_id,
                                                        @Query("bless_user_id") String bless_user_id,
                                                        @Query("token") String token);

    @GET(Config.VERSION + "im/getSolarTermsInfo")
    Observable<PionImDataBean> getSolarTermsInfo(@Query("user_id") String user_id,
                                                 @Query("date_time") long date_time,
                                                 @Query("token") String token);

    @GET(Config.VERSION + "im/userTempList")
    Observable<PionImMoBanDataBean> getQuickList(@Query("user_id") String user_id,
                                                 @Query("token") String token);

    @GET(Config.VERSION + "im/addUserTemp")
    Observable<ResponseBean> addQuickMoBan(@Query("user_id") String user_id,
                                           @Query("main") String main,
                                           @Query("token") String token);

    @GET(Config.VERSION + "im/delUserTemp")
    Observable<ResponseBean> DelMoBan(@Query("user_id") String user_id,
                                      @Query("im_user_temp_id") String im_user_temp_id,
                                      @Query("token") String token);
    ...
    @GET(Config.VERSION + "zhufubao/zhufubaoRewardIndex")
    Observable<DaiFuDataBean> zhufubaoRewardIndex(@Query("user_id") String user_id,
                                                  @Query("token") String token);
    ...
    @GET(Config.VERSION + "zhufubao/zhufubaoRewardSubmit")
    Observable<EditListDataBean> zhufubaoRewardSubmit(@Query("user_id") String user_id,
                                                      @Query("knp_team_bind_card_id") String knp_team_bind_card_id,
                                                      @Query("zhufubao_number") String zhufubao_number,
                                                      @Query("token") String token);

    @GET(Config.VERSION + "zhufubao/buyZhufubaoByWeixin")
    Observable<PayWXDataBean> buyZhufubaoByWeixin(@Query("user_id") String user_id,
                                                  @Query("pay_source") int pay_source,
                                                  @Query("price") String price,
                                                  @Query("token") String token);

    @GET(Config.VERSION + "zhufubao/rewardList")
    Observable<DaiFuDataBean> getRewardList(@Query("user_id") String user_id,
                                            @Query("page") int page,
                                            @Query("pageSize") int page_size,
                                            @Query("type") int type,
                                            @Query("token") String token);

    @GET(Config.VERSION + "zhufubao/buyZhufubaoByCash")
    Observable<EditDataBean> buyZhufubaoByCash(@Query("user_id") String user_id,
                                               @Query("pay_source") int pay_source,
                                               @Query("price") String price,
                                               @Query("token") String token);

    @GET(Config.VERSION + "zhufubao/componyBankInfo")
    Observable<DaiFuDataBean> componyBankInfo(@Query("user_id") String user_id,
                                              @Query("token") String token);
    ...
    @GET(Config.VERSION + "zhufubao/cashOrderConsultStatusUser")
    Observable<EditListDataBean> userConsult(@Query("user_id") String user_id,
                                             @Query("user_zhufubao_order_id") String user_zhufubao_order_id,
                                             @Query("user_consult_status") int user_consult_status,
                                             @Query("token") String token);

    @GET(Config.VERSION + "zhufubao/cashOrderConsultStatusBless")
    Observable<EditListDataBean> cashOrderConsultStatusBless(@Query("user_id") String user_id,
                                                             @Query("user_zhufubao_order_id") String user_zhufubao_order_id,
    ...
    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/userCashPushList")
    Observable<PairUDataBean> userCashPushList(@Field("user_id") String user_id,
                                               @Field("token") String token);

    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/blessDaichongLayer")
    Observable<PairUDataBean> blessDaichongLayer(@Field("user_id") String user_id,
                                                 @Field("token") String token);
    ...
    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/teacherCancelCashOrder")
    Observable<EditListDataBean> teacherCancelCashOrder(@Field("user_id") String user_id,
                                                        @Field("user_zhufubao_order_id") String user_zhufubao_order_id,
                                                        @Field("token") String token);

    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/teacherReceiveCashOrder")
    Observable<EditListDataBean> teacherReceiveCashOrder(@Field("user_id") String user_id,
                                                         @Field("user_zhufubao_order_id") String user_zhufubao_order_id,
                                                         @Field("is_customer") int is_customer,
                                                         @Field("token") String token);


    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/teacherCancelRechargeOrder")
    Observable<EditListDataBean> teacherCancelRechargeOrder(@Field("user_id") String user_id,
                                                            @Field("user_zhufubao_order_id") String user_zhufubao_order_id,
                                                            @Field("token") String token);

    @FormUrlEncoded
    @POST(Config.VERSION + "zhufubao/teacherReceiveRechargeOrder")
    Observable<EditListDataBean> teacherReceiveRechargeOrder(@Field("user_id") String user_id,
                                                             @Field("user_zhufubao_order_id") String user_zhufubao_order_id,
                                                             @Field("token") String token);
    ...
    @GET(Config.VERSION + "zhufubao/rewardCustomer")
    Observable<RewardListDataBean> rewardCustomer(@Query("user_id") String user_id,
                                                  @Query("type") int type,
                                                  @Query("page") int page,
                                                  @Query("pageSize") int pageSize,
                                                  @Query("token") String token);
    ...
    @GET(Config.VERSION + "zhufubao/cashRecord")
    Observable<TXRecordDataBean> getTXRecordList(@Query("user_id") String user_id,
                                                 @Query("select_type") int select_type,
                                                 @Query("page") int page,
                                                 @Query("page_size") int page_size,
                                                 @Query("token") String token);
    ...
    Observable<ResponseBean> receive(@Query("user_id") String user_id, @Query("help_need_order_id") int help_need_order_id,
                                     @Query("token") String token);

    //拒绝他
    @GET(Config.VERSION + "helpneed/refuse")
    Observable<ResponseBean> refuse(@Query("user_id") String user_id, @Query("help_need_order_id") int help_need_order_id,
                                    @Query("token") String token);
    ...
    @GET(Config.VERSION + "entrepreneurs/getRechargeEntrepreneurs")
    Observable<PionZFBSelectDataBean> getRechargeEntrepreneurs(@Query("user_id") String user_id,
                                                               @Query("phone") String phone,
                                                               @Query("token") String token);
