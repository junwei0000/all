 ...
 * 设置开通创业中心权限--开通记录
 */
public class PionOpenSetRecordActivity extends BaseListActivity<PionOpenSetContract.View, PionpenSetPresenterImp<PionOpenSetContract.View>> implements PionOpenSetContract.View {
    ...
    public void setListener() {
        pageTopTvName.setText("开通记录");
        notDateCont.setText("暂无开通记录");
    ...
    private void getList(int page) {
        mPresent.getOpenRecordList(page, pageSize);
    }
    ...
    PionOpenSetRecordAdapter mAdapter;
    ...
    public void ListSuccess(PionOpenSetRecordDataBean responseBean, int backPage) {
        ...
        if (status.equals("400")) {
            ...
            if (mAdapter == null) {
                mAdapter = new PionOpenSetRecordAdapter(mContext, helpList);
