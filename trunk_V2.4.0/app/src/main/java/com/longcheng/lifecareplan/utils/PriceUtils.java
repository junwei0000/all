...
public class PriceUtils {
    ...
    //复制
    public void copy(Activity activity, String data) {
        // 获取系统剪贴板
    ...
    //粘贴
    public void paste(Activity activity, TextView output) {
        // 获取系统剪贴板
        ClipboardManager clipboard = (ClipboardManager) activity.getSystemService(Context.CLIPBOARD_SERVICE);
        // 获取剪贴板的剪贴数据集
     ...
     * @return
     */
    public String getStrWeiShuUp(String money){
        //保留三位小数向上截取（非四舍五入）
        double d = new BigDecimal(money).setScale(2, BigDecimal.ROUND_UP).doubleValue();
