...
import com.longcheng.lifecareplan.modular.helpwith.reportbless.adapter.FuLiListAdapter;
import com.longcheng.lifecareplan.modular.helpwith.reportbless.adapter.FuQiListAdapter;
...
public abstract class FuLiBaseFrag extends BaseListFrag<ReportContract.View, ReportPresenterImp<ReportContract.View>> implements ReportContract.View {
    ...
    private FuLiListAdapter mAdapter;

    String exponent;

    public static final int INDEX_ALL = 1;
    public static final int INDEX_COMING = 2;
    public static final int INDEX_GET = 3;
    public static final int INDEX_NOTGET = 4;
    ...
    private void getList(int page) {
        mPresent.getFuLiList(user_id, getType(), page, pageSize);
    }
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    mPresent.getLingQu(user_id, bless_id);
                    break;
            }
        }
    };
    ...
    public void ListSuccess(ReportDataBean responseBean, int back_page) {
        ...
        if (status_.equals("400")) {
            ...
            if (mOrderAfterBean != null) {
                ...
                if (mAdapter == null) {
                    mAdapter = new FuLiListAdapter(getActivity(), mList, mHandler, getType());
    ...
    public void lingQuSuccess(EditDataBean responseBean) {
        ...
        if (status.equals("400")) {
            ...
            ToastUtils.showToast(responseBean.getMsg());
            ((FuLiFramgemt) getParentFragment()).reLoadList();
        }
    }
