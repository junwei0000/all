...
public class VenuesListInfo {
	...
	public VenuesListInfo(String posid, String uid, String field_name,
			String sportsType, String thumb, String venuestatus,
			String audit_status, double top_left_x, double top_left_y,
