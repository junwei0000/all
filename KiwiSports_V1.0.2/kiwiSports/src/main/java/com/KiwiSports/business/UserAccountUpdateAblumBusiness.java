...
public class UserAccountUpdateAblumBusiness {
	...
	public UserAccountUpdateAblumBusiness(Context mContext,
			HashMap<String, String> mhashmap, File tempFile,
	...
	private void getDate() {
		MultiPartStringRequest mJsonObjectRequest = new MultiPartStringRequest(
				Request.Method.POST, Constants.USERUPDATEABLUM,
				new Listener<String>() {
