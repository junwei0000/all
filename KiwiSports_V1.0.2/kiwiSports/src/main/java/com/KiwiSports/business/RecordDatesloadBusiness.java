...
public class RecordDatesloadBusiness {
	...
	public RecordDatesloadBusiness(Context mContext,
			HashMap<String, String> mhashmap,
			GetRecordDatesloadCallback mGetDataCallback) {
	...
	private void getDate() {
		String path = Constants.RECORDLOAD;
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, path,
				new Listener<String>() {
					public void onResponse(String response) {
						Log.e("TESTLOG", "-------loadTrackHistoryDates----response------------"
								+ response);
