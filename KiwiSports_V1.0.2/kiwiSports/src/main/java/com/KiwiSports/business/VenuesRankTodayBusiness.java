...
public class VenuesRankTodayBusiness {
	...
	public interface GetVenuesRankTodayCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetVenuesRankTodayCallback mGetDataCallback;
