	...
	public HashMap<String, Object> parseJSON(JSONObject jsonObject) {
		...
		try {
			...
			if (status.equals("200")) {
				...
				double distanceTraveled = myRankObs.optDouble(
						"distanceTraveled", 0);
				...
				VenuesRankTodayInfo myRankInfo = new VenuesRankTodayInfo(
						is_anonymous, distanceTraveled, uid, posid, date_time,
				...
				for (int i = 0; i < dayRanka.length(); i++) {
					...
					distanceTraveled = dayRankObs.optDouble("distanceTraveled",
							0);
					...
					VenuesRankTodayInfo dayRankInfo = new VenuesRankTodayInfo(
							is_anonymous, distanceTraveled, uid, posid,
