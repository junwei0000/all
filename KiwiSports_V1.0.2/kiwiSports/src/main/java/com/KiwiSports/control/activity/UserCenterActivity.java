...
public class UserCenterActivity extends BaseActivity {
	...
	public void onClick(View v) {
		...
		case R.id.usrecenter_tv_cancel:
			CommonUtils.getInstance().defineBackPressed(mHomeActivity,
					mCancelHandler, CANCEL, Constants.getInstance().cancel);
			break;
	...
	protected void setListener() {
		...
		welcomeSharedPreferences = context.getSharedPreferences(welcomeSPFKey,
				0);
		...
		cb_myanonlocation
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(CompoundButton buttonView,
						...
						mUpdateInfoUtils.UpdateInfo("is_anonymous",
								is_anonymous);
	...
	private void initSelectBox() {
		...
		boolean cb_lowpowerstatus = welcomeSharedPreferences.getBoolean(
				"cb_lowpowerstatus", false);
		boolean cb_voicestatus = welcomeSharedPreferences.getBoolean(
				"cb_voicestatus", true);
	...
	public void skipToTreasureList(View view) {
		Intent intent = new Intent(mHomeActivity, UserTreasureActivity.class);
		intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
	...
	private void logout() {
		...
		new UserLogoutBusiness(mHomeActivity, mhashmap,
				new GetLogoutCallback() {
					@Override
