...
public class VenuesRankActivity extends BaseActivity {
	...
	private void initHeadView() {
		...
		convertView = LayoutInflater.from(context).inflate(
				R.layout.venues_rank_item_top, null);
		rankitemtop_layout2 = (LinearLayout) convertView
				.findViewById(R.id.rankitemtop_layout2);
		...
		rankitemtop_tv_num2 = (TextView) convertView
				.findViewById(R.id.rankitemtop_tv_num2);

		rankitemtop_layout1 = (LinearLayout) convertView
				.findViewById(R.id.rankitemtop_layout1);
		...
		rankitemtop_tv_num1 = (TextView) convertView
				.findViewById(R.id.rankitemtop_tv_num1);

		rankitemtop_layout3 = (LinearLayout) convertView
				.findViewById(R.id.rankitemtop_layout3);
		...
		rankitemtop_tv_num3 = (TextView) convertView
				.findViewById(R.id.rankitemtop_tv_num3);
	}
	...
	protected void processLogic() {
		...
		new VenuesRankTodayBusiness(this, mhashmap,
				new GetVenuesRankTodayCallback() {
					...
					public void afterDataGet(HashMap<String, Object> dataMap) {
						if (dataMap != null) {
							...
							if (status.equals("200")) {
								mtopList = (ArrayList<VenuesRankTodayInfo>) dataMap
										.get("mtopList");
								mList = (ArrayList<VenuesRankTodayInfo>) dataMap
										.get("mList");
								showAdapter();
							}
						} else {
	...
	private void showAdapter() {
		...
		if (mtopList != null && mtopList.size() > 0) {
			...
			if (mtopList.size() >= 1) {
				...
				rankitemtop_layout1
						.setBackgroundResource(R.drawable.corners_circular_yellow);
				rankitemtop_tv_name1.setText(name);
				rankitemtop_tv_num1.setText(PriceUtils.getInstance()
			...
			if (mtopList.size() >= 2) {
				...
				rankitemtop_layout2
						.setBackgroundResource(R.drawable.corners_circular_gray);
				rankitemtop_tv_name2.setText(name);
				rankitemtop_tv_num2.setText(PriceUtils.getInstance()
						.formatFloatNumber(diatance) + "km");
			}
			if (mtopList.size() >= 3) {
				...
				rankitemtop_layout3
						.setBackgroundResource(R.drawable.corners_circular_dian);
				rankitemtop_tv_name3.setText(name);
				rankitemtop_tv_num3.setText(PriceUtils.getInstance()
						.formatFloatNumber(diatance) + "km");
			}
		}
		...
		VenuesRankAdapter mVenuesRankAdapter = new VenuesRankAdapter(context,
				mList, max);
	...
	protected void getRankAll() {
		...
		mhashmap.put("access_token", access_token);
		mhashmap.put("posid", posid);
		new VenuesRankAllBusiness(this, mhashmap,
				new GetVenuesRankAllCallback() {
					@SuppressWarnings("unchecked")
					@Override
					public void afterDataGet(HashMap<String, Object> dataMap) {
						if (dataMap != null) {
