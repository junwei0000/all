...
public class MyCalendarView extends LinearLayout implements OnClickListener {
    ...
    /**
     * 修改：jumpYear jumpMonth去掉 static 防止每次进入不会初始化
     */
    ...
    public void init(Handler mHandler, int mHandlerID) {
    ...
    public void setSelectDate(String selectdate_) {
        ...
        flipper = (ViewFlipper) findViewById(R.id.flipper);
        flipper.removeAllViews();
        calV = new CalendarAdapter(mContext, getResources(), year_c, month_c, day_c, selectdate_);
        addGridView();
        gridView.setAdapter(calV);
        flipper.addView(gridView, 0);
        addTextToTopTextView(currentMonth);
    ...
    class MyGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
            ...
            if (e1.getX() - e2.getX() > 120) {
                // 向左滑动
                Log.e("CalendarAdapter", "getShowYear=" + calV.getShowYear() + "  ;getShowMonth=" + calV.getShowMonth());
