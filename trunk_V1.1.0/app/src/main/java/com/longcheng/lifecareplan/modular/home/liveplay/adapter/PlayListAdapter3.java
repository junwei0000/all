...
public class PlayListAdapter3 extends BaseAdapterHelper<LivePlayItemInfo> {
    ViewHolder mHolder = null;
    Context context;

    boolean liveSeleStatus;

    public PlayListAdapter3(Context context, List<LivePlayItemInfo> list, boolean liveSeleStatus) {
        super(context, list);
