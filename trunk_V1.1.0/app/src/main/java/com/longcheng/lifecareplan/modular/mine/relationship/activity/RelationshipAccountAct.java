    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvmycontribution://我的奉献
                startActivity(new Intent(RelationshipAccountAct.this, MyDedicationActivity.class));
                break;
            case R.id.tvmybenefactor://我的恩人
                startActivity(new Intent(RelationshipAccountAct.this, MyGratitudeActivity.class));
                break;
        }
    }
