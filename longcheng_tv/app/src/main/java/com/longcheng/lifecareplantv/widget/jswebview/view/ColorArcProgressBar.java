...
public class ColorArcProgressBar extends View {
    ...
    private String hintColor = "#dedede";
    private String longDegreeColor = "#dedede";
    private String shortDegreeColor = "#dedede";
    private String bgArcColor = "#dedede";
    ...
    private void initView() {
        int bmpW = BitmapFactory.decodeResource(getResources(), R.mipmap.detail_progress_round).getWidth();
        int progressWid = bmpW - DensityUtil.dip2px(getContext(), 90) + DensityUtil.dip2px(getContext(), 12);
        diameter = progressWid;
        //弧形的矩阵区域
        bgRect = new RectF();
    ...
    public void setDiameterPx(int diameter) {
