package com.longcheng.lifecareplantv.utils.apkupload.service;
...
import com.longcheng.lifecareplantv.utils.apkupload.utils.IOUtils;
import com.longcheng.lifecareplantv.utils.apkupload.utils.InstallUtil;
import com.longcheng.lifecareplantv.utils.apkupload.utils.SystemManager;
...
public class DownloadService extends Service {
    ...
    public class DownloadBinder extends Binder {
        ...
        public long startDownload(String apkUrl) {
            //点击下载
            //删除原有的APK
            IOUtils.clearApk(DownloadService.this, ConstantManager.UPLOAD_APK_NAME);
            //使用DownLoadManager来下载
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的
            //这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), ConstantManager.UPLOAD_APK_NAME);
