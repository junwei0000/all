package com.longcheng.lifecareplantv.widget.jswebview.view;
...
public class CircleInProgressBar extends View {
    ...
    public CircleInProgressBar(Context context) {
        this(context, null);
    }

    public CircleInProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_styleIn, LINE);
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_textsize, DensityUtil.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
...
//        canvas.drawArc(mProgressRectF, 0.0f, MAX_DEGREE * mProgress / mMax, false, mProgressPaint);
        /**
         * ****************防止 paint.setStrokeCap 导致外圈和内圈进度不一样********************
         */
        if (mProgress < 100 && mProgress > 0) {
            canvas.drawArc(mProgressRectF, 0.0f + 2, MAX_DEGREE * mProgress / mMax - 4, false, mProgressPaint);
        } else {
            canvas.drawArc(mProgressRectF, 0.0f, MAX_DEGREE * mProgress / mMax, false, mProgressPaint);
        }
    }
