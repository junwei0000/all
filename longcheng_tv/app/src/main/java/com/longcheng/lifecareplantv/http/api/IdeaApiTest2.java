...
import com.longcheng.lifecareplantv.utils.network.NetworkUtils;
...
public class IdeaApiTest2 {
    private Retrofit retrofit;
    private IdeaApiService service;

    private IdeaApiTest2() {
        //拦截器
...
//                .addInterceptor(new HttpHeaderInterceptor())
        ...
        retrofit = new Retrofit.Builder()
                ...
                .baseUrl("https://www.bestdo.com/new-bd-app/2.7.0/")
                .build();
    ...
    private static class SingletonHolder {
        private static final IdeaApiTest2 INSTANCE = new IdeaApiTest2();
    }
