	...
	public HashMap<String, Object> parseJSON(JSONObject jsonObject) {
		...
		try {
			...
			if (status.equals("200")) {
				...
				String isBind = jsonOb.optString("isBind", "0");
				if (!TextUtils.isEmpty(isBind) && isBind.equals("1")) {
					...
					loginInfo = new UserLoginInfo(uid, sid, mobile, ablum, loginName, nickName, realName, sex, qq,
							email, nameChangeTimes, bid, bname, name, department, corp_id, manage_office_name,
