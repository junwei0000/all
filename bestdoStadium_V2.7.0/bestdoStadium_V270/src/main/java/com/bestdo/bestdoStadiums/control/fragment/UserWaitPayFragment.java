 ...
 * @Description 类描述：待付款
 */
public class UserWaitPayFragment extends Fragment implements OnRefreshListioner {
	...
	public UserWaitPayFragment() {
		super();
	}
	@SuppressLint("ValidFragment")
	public UserWaitPayFragment(Activity mContext, String uid) {
		super();
	...
	private void getData() {
		if (isAttached && mContext != null && mContext.selectArg0 == Integer
			...
			ordrStatuas = mContext.getResources().getString(R.string.order_putParameters_waitpay);
	...
	private void updateList() {
		...
		adapter = new UserOrderAdapter(mContext, orderlist, mPullDownViewHandler, UPDATEVIEW, ordrStatuas);
