...
public class StadiumBusiness {
	...
	public StadiumBusiness(Context mContext, HashMap<String, String> mHashMap, ArrayList<StadiumInfo> mList,
	...
	private void getDate() {
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, Constans.GETSTADIUMLIST,
				new Listener<String>() {
