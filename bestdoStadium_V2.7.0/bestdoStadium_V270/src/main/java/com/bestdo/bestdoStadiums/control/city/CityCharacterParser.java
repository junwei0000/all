...
public class CityCharacterParser {
	private int[] pyvalue = new int[] { -20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230,
	...
	public String[] pystr = new String[] { "a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei",
	...
	private static CityCharacterParser characterParser;

	public static CityCharacterParser getInstance() {
		if (characterParser == null) {
			characterParser = new CityCharacterParser();
		}
