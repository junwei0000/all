 ...
 * 
 * @author 作者：zoc
 * @date 创建时间：2016-1-28 下午2:55:16
 * @Description 类描述：确认中
 */
public class UserConfirmingFragment extends Fragment implements OnRefreshListioner {
	...
	public UserConfirmingFragment(Activity mContext, String uid) {
		super();
		this.uid = uid;
	...
	private void getData() {
		if (isAttached && mContext != null && mContext.selectArg0 == Integer
				.valueOf(mContext.getResources().getString(R.string.order_index_confirming))) {
			...
			ordrStatuas = mContext.getResources().getString(R.string.order_putParameters_confirming);
