 ...
 * @Description 类描述：全部
 */
public class UserAllFragment extends Fragment implements OnRefreshListioner {
	...
	public UserAllFragment(Activity mContext, String uid) {
		super();
	...
	private void nideBottom() {
		if (!checkDataLoadStatus()) {
			mPullDownView.onLoadMoreComplete(getString(R.string.seen_more), "");// 这里表示加载更多处理完成后把下面的加载更多界面（隐藏或者设置字样更多）
