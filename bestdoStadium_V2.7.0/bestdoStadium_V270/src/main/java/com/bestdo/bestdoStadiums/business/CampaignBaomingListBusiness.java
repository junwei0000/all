 ...
 * @Description 类描述：
 */
public class CampaignBaomingListBusiness {

	public interface CampaignBaomingListCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private CampaignBaomingListCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;
	private String path;

	public CampaignBaomingListBusiness(Context mContext, HashMap<String, String> mhashmap,
			CampaignBaomingListCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		path = Constans.CAMPAIGNBAOMINGLIST;
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, path, new Listener<String>() {
			public void onResponse(String response) {
				...
				CampaignBaomingListParser mParser = new CampaignBaomingListParser();
