...
import com.bestdo.bestdoStadiums.control.adapter.AdvertImagePagerAdapterDecorator;
import com.bestdo.bestdoStadiums.control.adapter.RecyclingPagerAdapter;
...
public class AutoScrollViewPager extends ViewPager {
	...
	public boolean dispatchTouchEvent(MotionEvent ev) {
		...
		if (stopScrollWhenTouch) {
			if ((action == MotionEvent.ACTION_DOWN) && isAutoScroll) {
				isStopByTouch = true;
				 stopAutoScroll();//当手指碰到ViewPager时是否停止自动滚动
	...
	public void setAdapter(PagerAdapter advertPagerAdapter) {
		...
		super.setAdapter(new AdvertImagePagerAdapterDecorator((RecyclingPagerAdapter) advertPagerAdapter));
	}
