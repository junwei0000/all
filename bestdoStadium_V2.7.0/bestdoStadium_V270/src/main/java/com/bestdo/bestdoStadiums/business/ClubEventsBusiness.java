 ...
 * @Description 类描述：
 */
public class ClubEventsBusiness {

	public interface ClubEventsListCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private ClubEventsListCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public ClubEventsBusiness(Context mContext, HashMap<String, String> mhashmap,
			ClubEventsListCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, Constans.CLUBACTIVITYLIST,
				new Listener<String>() {
					public void onResponse(String response) {
						System.err.println(response);
						JSONObject jsonObject = RequestUtils.String2JSON(response);
						HashMap<String, Object> dataMap = new HashMap<String, Object>();// 深拷贝（只赋值，重新在堆内存开辟新地址）
						ClubEventsParser mParser = new ClubEventsParser();
