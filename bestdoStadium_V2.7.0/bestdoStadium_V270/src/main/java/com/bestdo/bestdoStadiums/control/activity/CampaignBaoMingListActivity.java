 ...
 */
public class CampaignBaoMingListActivity extends BaseActivity implements OnRefreshListioner {
	...
	private OnItemClickListener itemListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
			...
			if (mList != null && arg2 <= mList.size()) {
				String act_status = mList.get(arg2 - 1).getAct_status();
	...
	private void updateList() {
		...
		if (mAdapter == null) {
			mAdapter = new CampaignManagerListAdapter(context, mList, "Registered");
