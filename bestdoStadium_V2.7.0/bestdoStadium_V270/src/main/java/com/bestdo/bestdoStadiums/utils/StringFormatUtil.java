...
public class StringFormatUtil {
	...
	public StringFormatUtil fillColor() {
		...
		spBuilder.setSpan(charaStyle, start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);// 改变字体颜色
		spBuilder.setSpan(new AbsoluteSizeSpan(25, true), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);// 改变大小
		return this;
	}
