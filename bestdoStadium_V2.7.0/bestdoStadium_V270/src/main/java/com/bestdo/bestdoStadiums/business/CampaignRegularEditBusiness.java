 ...
 * @Description 类描述：活动-固定活动编辑
 */
public class CampaignRegularEditBusiness {

	public interface CampaignRegularEditCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private CampaignRegularEditCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public CampaignRegularEditBusiness(Context mContext, HashMap<String, String> mhashmap,
			CampaignRegularEditCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		String pathString = Constans.CAMPAIGNREGULAREDIT;
