...
public class MessageBusiness {
	...
	private MessageCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public MessageBusiness(Context mContext, HashMap<String, String> mhashmap, MessageCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, Constans.MESSAGE, new Listener<String>() {
