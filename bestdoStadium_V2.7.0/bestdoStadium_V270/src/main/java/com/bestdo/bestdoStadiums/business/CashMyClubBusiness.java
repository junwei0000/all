 ...
 * @Description 类描述：
 */
public class CashMyClubBusiness {

	public interface CashMyClubCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private CashMyClubCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public CashMyClubBusiness(Context mContext, HashMap<String, String> mhashmap, CashMyClubCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, Constans.CASHMYCLUB, new Listener<String>() {
			public void onResponse(String response) {
				System.err.println(response);
				JSONObject jsonObject = RequestUtils.String2JSON(response);
				HashMap<String, Object> dataMap = new HashMap<String, Object>();// 深拷贝（只赋值，重新在堆内存开辟新地址）
				CashMyClubParser mParser = new CashMyClubParser();
