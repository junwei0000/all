...
public class SupplierEditText extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	public SupplierEditText(Context context) {
		this(context, null);
	}

	public SupplierEditText(Context context, AttributeSet attrs) {
		// 这里构造方法也很重要，不加这个很多属性不能再XML里面定义
		this(context, attrs, android.R.attr.editTextStyle);
	}

	public SupplierEditText(Context context, AttributeSet attrs, int defStyle) {
