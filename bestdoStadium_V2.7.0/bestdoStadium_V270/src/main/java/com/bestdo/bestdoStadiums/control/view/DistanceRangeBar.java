...
public class DistanceRangeBar extends View {
	...
	private int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.stadiummaplist_bottom_distancethumb;
	private int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.stadiummaplist_bottom_distancethumb;
	...
	private DistanceRangeBar.OnRangeBarChangeListener mListener;
	 ...
	 *            existing listener
	 */
	public void setOnRangeBarChangeListener(DistanceRangeBar.OnRangeBarChangeListener listener) {
		mListener = listener;
	}
	 ...
	 *            Integer specifying the index of the right thumb 设置刻度
	 */
	 ...
	 * @param none
	 */
	public void createThumbs(int mRightIndex) {

		Context ctx = getContext();
		float yPos = getYPos();

		// mLeftThumb = new DistanceThumb(ctx, yPos, mThumbColorNormal,
	...
	public interface OnRangeBarChangeListener {
		...
		public void onIndexChangeListener(DistanceRangeBar rangeBar, int leftThumbIndex, int rightThumbIndex);
	}
}
