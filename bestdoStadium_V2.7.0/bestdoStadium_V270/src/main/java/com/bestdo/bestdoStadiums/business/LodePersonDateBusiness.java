...
public class LodePersonDateBusiness {
	...
	public LodePersonDateBusiness(Context mContext, HashMap<String, String> mhashmap,
			LodePersonDateCallback mGetDataCallback) {
	...
	private void getDate() {
		StringRequest mJsonObjectRequest = new StringRequest(Method.GET, Constans.LODEPERSONDATE,
