...
public class UserCardsActivity extends BaseActivity implements OnRefreshListioner {
	...
	protected void processLogic() {
		...
		new UserCardsBusiness(this, mhashmap, mList, Constans.USERCARDSLIST, new GetUserCardsCallback() {
			...
			public void afterDataGet(HashMap<String, Object> dataMap) {
				...
				if (dataMap != null) {
					...
					if (status.equals("400")) {
						...
						UserLoginBack403Utils.getInstance().showDialogPromptReLogin(UserCardsActivity.this);
					...
					CommonUtils.getInstance().initToast(UserCardsActivity.this, getString(R.string.net_tishi));
				}
	...
	private void showDilag() {
		try {
			if (mDialog == null) {
				mDialog = CommonUtils.getInstance().createLoadingDialog(UserCardsActivity.this);
			} else {
				mDialog.show();
			}
		} catch (Exception e) {
	...
	private void updateList() {
		...
		if (mUserCardsListAdapter == null) {
			mUserCardsListAdapter = new UserCardAdapter(UserCardsActivity.this, mList);
		...
		if (mUserCardsListAdapter == null || (mUserCardsListAdapter != null && mUserCardsListAdapter.getCount() == 0)) {
			...
			not_date_jihuo_btn.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent(UserCardsActivity.this, UserCardsBuyActivity.class);
					intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
					CommonUtils.getInstance().intntStatus = "UserCenterActivity";
					startActivity(intent);
					CommonUtils.getInstance().setPageIntentAnim(intent, UserCardsActivity.this);
	...
	class listItemClick implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			if (mList != null && position <= mList.size()) {
				...
				Intent intent = new Intent(UserCardsActivity.this, UserCardDetailActivity.class);
				...
				intent.putExtra("skipToCardDetailStatus", Constans.getInstance().skipToCardDetailByListPage);
				startActivity(intent);
				CommonUtils.getInstance().setPageIntentAnim(intent, UserCardsActivity.this);
			}
		}
