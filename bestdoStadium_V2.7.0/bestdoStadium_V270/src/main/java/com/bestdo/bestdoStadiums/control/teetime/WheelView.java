...
public class WheelView extends View {
	...
	private int VALUE_TEXT_COLOR = Color.parseColor("#3EA1Df");
	 ...
	 */
	private int ADDITIONAL_ITEM_HEIGHT = 45;
	...
	private void initData(Context context) {
		...
		dm = ConfigUtils.getInstance().getPhoneWidHeigth(context);
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		Log.e("---------calculateLayoutWidth----", "---------calculateLayoutWidth----");
	...
	private void createLayouts(int widthItems, int widthLabel) {
		Log.e("-----createLayouts-------", "widthItems=" + widthItems);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		int width = ConfigUtils.getInstance().dip2px(context, dm.widthPixels);
