...
import com.bestdo.bestdoStadiums.utils.parser.CashUpdateParser;
 ...
 * @Description 类描述：
 */
public class CashbookUpdateBusiness {

	public interface GetCashbookUpdateCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetCashbookUpdateCallback mGetDataCallback;
	HashMap<String, String> mHashMap;
	Context mContext;
	String path;

	public CashbookUpdateBusiness(Context mContext, HashMap<String, String> mHashMap, String path,
			GetCashbookUpdateCallback mGetDataCallback) {
	...
	private void getDate() {
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, path, new Listener<String>() {
			public void onResponse(String response) {
				...
				CashUpdateParser mParser = new CashUpdateParser();
