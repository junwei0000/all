...
//		mProgressBar = (ProgressBar) findViewById(R.id.xrefreshview_header_progressbar);
		...
		mArrowImageView2=(ImageView) findViewById(R.id.refresh_main_top_img2);
		frameAnimation = (AnimationDrawable) context
				.getResources().getDrawable(R.anim.xiala_anim);
		mArrowImageView2.setBackgroundDrawable(frameAnimation);
