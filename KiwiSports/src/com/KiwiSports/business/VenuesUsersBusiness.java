 ...
 * @Description 类描述：场地范围的用户
 */
public class VenuesUsersBusiness {

	public interface GetVenuesUsersCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetVenuesUsersCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public VenuesUsersBusiness(Context mContext, HashMap<String, String> mhashmap,
			GetVenuesUsersCallback mGetDataCallback) {
	...
	private void getDate() {
		String path = Constans.VENUESUSERS;
