 ...
 * @Description 类描述： 
 */
public class RecordDetailBusiness {

	public interface GetRecordDetailCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}
	private GetRecordDetailCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public RecordDetailBusiness(Context mContext,  HashMap<String, String> mhashmap, GetRecordDetailCallback mGetDataCallback) {
	...
	private void getDate() {
		String path = Constans.RECORDDETAIL;
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, path, new Listener<String>() {
			public void onResponse(String response) {
				...
				RecordDetailParser mParser = new RecordDetailParser();
