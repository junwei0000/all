...
import com.KiwiSports.utils.parser.VenuesRankAllParser;
import com.KiwiSports.utils.parser.VenuesRankTodayParser;
 ...
 * @Description 类描述： 
 */
public class VenuesRankAllBusiness {

	public interface GetVenuesRankAllCallback {
		public void afterDataGet(HashMap<String, Object> dataMap);
	}

	private GetVenuesRankAllCallback mGetDataCallback;
	HashMap<String, String> mhashmap;
	Context mContext;

	public VenuesRankAllBusiness(Context mContext,
			HashMap<String, String> mhashmap, GetVenuesRankAllCallback mGetDataCallback) {
