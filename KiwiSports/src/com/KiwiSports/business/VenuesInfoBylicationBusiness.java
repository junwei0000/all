...
public class VenuesInfoBylicationBusiness {
	...
	public VenuesInfoBylicationBusiness(Context mContext, HashMap<String, String> mhashmap, GetInfoBylicationCallback mGetDataCallback) {
	...
	private void getDate() {
		...
		StringRequest mJsonObjectRequest = new StringRequest(Method.POST, Constans.VENUESINFOBYLOCATION, new Listener<String>() {
