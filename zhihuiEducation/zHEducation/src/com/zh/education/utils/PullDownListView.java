...
public class PullDownListView extends FrameLayout implements
	...
	protected void onFinishInflate() {
		...
		refreshbottom_line = (ImageView) foot
				.findViewById(R.id.refreshbottom_line);
	...
	public void initBg(Context context, BaseAdapter mAdapter) {
		...
		int heightPixel = ScreenUtils.getScreenHeight(context);
	...
	public void onLoadMore() {
		if (!loadstatus.equals("over")) {
			...
			// footer_layout.setAnimation(CommonUtils.getInstance().showAnimBottom2Top());
		}
	}
	...
	public void onLoadMoreComplete(String date, String loadstata) {
		...
		mState = -1;
		mProgressBar2.setVisibility(View.GONE);
		// more.setVisibility(View.GONE);//设置隐藏
		more.setText(date);
		updateCommon();
		if (isFirstLoading)
		...
		// footer_layout.setVisibility(View.GONE);
		// footer_layout.setAnimation(CommonUtils.getInstance().showAnimTop2Bottom());
	}
