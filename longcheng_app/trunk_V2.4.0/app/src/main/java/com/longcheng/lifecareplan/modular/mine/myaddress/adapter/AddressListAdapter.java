...
public class AddressListAdapter extends BaseAdapterHelper<AddressItemBean> {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            item_tv_address = view.findViewById(R.id.item_tv_address);
            item_tv_check = view.findViewById(R.id.item_tv_check);
            item_tv_moren = view.findViewById(R.id.item_tv_moren);
            item_tv_edit = view.findViewById(R.id.item_tv_edit);
            item_tv_del = view.findViewById(R.id.item_tv_del);
