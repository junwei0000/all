...
public class ImmersionBarUtils {
    ...
    private void init(Activity activity, Toolbar toolbar) {
        ImmersionBar.with(activity)
                ...
                .barColor(R.color.black)  //同时自定义状态栏和导航栏颜色，不写默认状态栏为透明色，导航栏为黑色
                ...
                .titleBarMarginTop(toolbar)     //解决状态栏和布局重叠问题，任选其一
                .statusBarView(toolbar)  //解决状态栏和布局重叠问题，任选其一
                .fitsSystemWindows(true)    //解决状态栏和布局重叠问题，任选其一，默认为false，当为true时一定要指定statusBarColor()，不然状态栏为透明色，还有一些重载方法
                .supportActionBar(true) //支持ActionBar使用
                .statusBarColorTransform(R.color.black)  //状态栏变色后的颜色
                .navigationBarColorTransform(R.color.black) //导航栏变色后的颜色
                .barColorTransform(R.color.black)  //状态栏和导航栏变色后的颜色
