package com.longcheng.lifecareplan.modular.mine.pioneercenter.caililist.adapter;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.caililist.activity.PionCailiBaseOrderFrag;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.caililist.bean.PionCailiItemBean;
...
public class PionCailiListAdapter extends BaseAdapterHelper<PionCailiItemBean> {
    ViewHolder mHolder = null;
    Handler mHandler;
    Activity context;
    List<PionCailiItemBean> list;

    public PionCailiListAdapter(Activity context, List<PionCailiItemBean> list, Handler mHandler) {
        super(context, list);
    ...
    public List<PionCailiItemBean> getList() {
        return list;
    }

    public void setList(List<PionCailiItemBean> list) {
        this.list = list;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<PionCailiItemBean> list, LayoutInflater inflater) {
        ...
        PionCailiItemBean mOrderItemBean = list.get(position);
        ...
        mHolder.item_tv_sure.setTag(mOrderItemBean.getEntrepreneurs_apply_rebate_id());
        mHolder.item_tv_sure.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String entrepreneurs_apply_rebate_id = (String) v.getTag();
                Message message = Message.obtain();
                message.what = PionCailiBaseOrderFrag.SUREPAY;
                message.obj = entrepreneurs_apply_rebate_id;
        ...
        mHolder.item_tv_copy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PionCailiItemBean mOrderItemBean = (PionCailiItemBean) v.getTag();
                String cont = "打款银行信息\n"
