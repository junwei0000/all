...
//                mCurrentPosition = position;
        ...
        mVerticalViewPager.setPageTransformer(false, new ViewPager.PageTransformer() {
            ...
            public void transformPage(View page, float position) {
                ...
                record_preview = viewGroup.findViewById(R.id.record_preview);
                iv_dianzan = viewGroup.findViewById(R.id.iv_dianzan);
                iv_follow = viewGroup.findViewById(R.id.iv_follow);
                frag_tv_dianzannum = viewGroup.findViewById(R.id.frag_tv_dianzannum);
                frag_tv_commentnum = viewGroup.findViewById(R.id.frag_tv_commentnum);
                frag_tv_sharenum = viewGroup.findViewById(R.id.frag_tv_sharenum);
    ...
    class MyPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            view.setId(position);
            ImageButton record_preview = view.findViewById(R.id.record_preview);
            ImageView player_iv_cover = view.findViewById(R.id.player_iv_cover);
            ...
            ImageView frag_iv_dashuang = view.findViewById(R.id.frag_iv_dashuang);
            LinearLayout frag_layout_dianzan = view.findViewById(R.id.frag_layout_dianzan);
            ImageView iv_dianzan = view.findViewById(R.id.iv_dianzan);
            TextView frag_tv_dianzannum = view.findViewById(R.id.frag_tv_dianzannum);
            LinearLayout frag_layout_comment = view.findViewById(R.id.frag_layout_comment);
            TextView frag_tv_commentnum = view.findViewById(R.id.frag_tv_commentnum);
            LinearLayout frag_layout_share = view.findViewById(R.id.frag_layout_share);
            TextView frag_tv_sharenum = view.findViewById(R.id.frag_tv_sharenum);

            LinearLayout frag_layout_zhufu = view.findViewById(R.id.frag_layout_zhufu);
            TextView frag_tv_zhufu = view.findViewById(R.id.frag_tv_zhufu);
            LinearLayout frag_layout_jieqi = view.findViewById(R.id.frag_layout_jieqi);
            TextView frag_tv_jieqi = view.findViewById(R.id.frag_tv_jieqi);
            LinearLayout frag_layout_city = view.findViewById(R.id.frag_layout_city);
            TextView frag_tv_city = view.findViewById(R.id.frag_tv_city);
            ImageView iv_follow = view.findViewById(R.id.iv_follow);
...
//                showNoMoreData(true, dateListview.getRefreshableView());
    ...
    public void showCommentDialog() {
        if (selectDialog == null) {
            ...
            tv_count = selectDialog.findViewById(R.id.tv_count);
            date_listview = selectDialog.findViewById(R.id.date_listview);
            et_content = selectDialog.findViewById(R.id.et_content);
            TextView tv_send = selectDialog.findViewById(R.id.tv_send);
