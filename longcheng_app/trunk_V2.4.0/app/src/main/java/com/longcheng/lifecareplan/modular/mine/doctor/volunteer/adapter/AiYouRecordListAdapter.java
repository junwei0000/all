package com.longcheng.lifecareplan.modular.mine.doctor.volunteer.adapter;
...
public class AiYouRecordListAdapter extends BaseAdapterHelper<AYRecordListDataBean.DocItemBean> {
    ViewHolder mHolder = null;
    Context context;


    public AiYouRecordListAdapter(Context context, List<AYRecordListDataBean.DocItemBean> list) {
        super(context, list);
        this.context = context;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<AYRecordListDataBean.DocItemBean> list, LayoutInflater inflater) {
        if (convertView == null) {
        ...
        AYRecordListDataBean.DocItemBean mOrderItemBean = list.get(position);
        ...
        mHolder.item_tv_status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AYRecordListDataBean.DocItemBean mOrderItemBean = (AYRecordListDataBean.DocItemBean) v.getTag();
                ...
                intent.putExtra("identityFlag", 3);
