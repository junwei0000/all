 ...
 * 1824榜单
 */
public class BangDan1824Activity extends BaseListActivity<BangDanContract.View, BangDanPresenterImp<BangDanContract.View>> implements BangDanContract.View {
    ...
    public void setListener() {
        ...
        layoutTop.setBackgroundResource(R.mipmap.bangdan_1824_bg);
    ...
    private void getList(int page) {
        mPresent.blessRanking(user_id, page, pageSize);
    }
    ...
    public void ListSuccess(BangDanDataBean responseBean, int backPage) {
        ...
        if (status_.equals("400")) {
            ...
            if (mEnergyAfterBean != null) {
                ...
                if (mAdapter == null) {
                    mAdapter = new BlessAdapter(mActivity, helpList, "bless_1824");
