package com.longcheng.lifecareplan.modular.mine.pioneercenter.user.activatenergy.daichong.activity.cz;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.user.activatenergy.daichong.adapter.PionCZRecordAdapter;
 ...
 * 代充记录
 */
public abstract class PionCZBaseFrag extends BaseListFrag<PionDCContract.View, PionDCPresenterImp<PionDCContract.View>> implements PionDCContract.View {
    ...
    private void getList(int page) {
        mPresent.PiongetCZList(page, pageSize, getType());
    }
        ...
        if (selectDialog == null) {
            ...
            tv_sure.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    selectDialog.dismiss();
                    if (type == Refuse) {
                        mPresent.updateOrderStatus(user_zhufubao_order_id, -1, 0, "");
                    } else if (type == RefuseTiXian) {
                        mPresent.PionCZuserConsult(user_zhufubao_order_id, -1);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case blessPaymentConfirm:
                    user_zhufubao_order_id = (String) msg.obj;
                    clickIndex = msg.arg1;
                    Intent intents = new Intent(mContext, PionCZConfirmActivity.class);
                ...
                case ConfirmTiXian:
                    ...
                    break;
                case REFRESH:
                    ((PionCZRecordActivity) getActivity()).reLoadList();
                    break;
            }
        }
    };
    ...
    PionCZRecordAdapter mDaiFuAdapter;
    ...
    public void ListSuccess(PionDaiCDataBean responseBean, int backPage) {
        ...
        if (status.equals("400")) {
            ...
            if (mDaiFuAfterBean != null) {
                ...
                if (mDaiFuAdapter == null) {
                    mDaiFuAdapter = new PionCZRecordAdapter(mContext, helpList, mHandler, getType());
