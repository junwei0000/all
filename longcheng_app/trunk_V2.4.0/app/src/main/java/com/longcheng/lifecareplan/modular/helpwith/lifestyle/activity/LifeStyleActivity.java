...
public class LifeStyleActivity extends BaseListActivity<LifeStyleContract.View, LifeStylePresenterImp<LifeStyleContract.View>> implements LifeStyleContract.View {
    ...
    private void showSelectPopupWindow(View view1) {
        ...
        LinearLayout layout_bottom = view.findViewById(R.id.layout_bottom);
        layout_bottom.getBackground().setAlpha(80);
        tv_blessme = view.findViewById(R.id.tv_blessme);
        iv_blessme = view.findViewById(R.id.iv_blessme);
        tv_mybless = view.findViewById(R.id.tv_mybless);
        iv_mybless = view.findViewById(R.id.iv_mybless);
        tv_notbless = view.findViewById(R.id.tv_notbless);
        iv_notbless = view.findViewById(R.id.iv_notbless);
        TextView btn_reset = view.findViewById(R.id.btn_reset);
