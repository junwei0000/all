 ...
 * 能量中心--已打款上传凭证
 */
public class PionDaiCConfirmActivity extends BaseListActivity<PionDCContract.View, PionDCPresenterImp<PionDCContract.View>> implements PionDCContract.View {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_givemoney:
                if (!TextUtils.isEmpty(bless_payment_photo)) {
                    if (!requestStatus) {
                        requestStatus = true;
                        mPresent.PiondaiCAgree(user_zhufubao_order_id, bless_payment_channel, bless_payment_photo);
                    }
                } else {
    ...
    public void setListener() {
        ...
        tv_montitle.setText("请选择您向用户收款的方式");
    ...
    public void RefuseSuccess(ResponseBean responseBean) {
        ...
        PionDaiCActivity.editOrderStatus = true;
