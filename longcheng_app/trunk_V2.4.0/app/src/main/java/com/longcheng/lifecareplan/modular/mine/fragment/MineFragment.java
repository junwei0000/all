...
import com.longcheng.lifecareplan.modular.mine.energycenter.rewardrecord.activity.RewardListActivity;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.caililist.activity.PionCailiListActivity;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.openPionSet.activity.PionOpenSetActivity;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.openorder.activity.PionOpenGMListActivity;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.order.activity.PionRewardListActivity;
...
import com.longcheng.lifecareplan.modular.mine.set.activity.UpgradeActivity;
...
import com.longcheng.lifecareplan.modular.mine.tixianrecord.activity.TiXianRecordListActivity;
...
public class MineFragment extends BaseFragmentMVP<MineContract.View, MinePresenterImp<MineContract.View>> implements MineContract.View {
    ...
    @BindView(R.id.layout_cashflow)
    LinearLayout layout_cashflow;
    ...
    @BindView(R.id.layout_tixianrecord)
    LinearLayout layout_tixianrecord;
    @BindView(R.id.layout_transferrecord)
    LinearLayout layout_transferrecord;
    @BindView(R.id.layout_jiujirecord)
    LinearLayout layout_jiujirecord;
    @BindView(R.id.layout_pionopenauthority)
    LinearLayout layout_pionopenauthority;
    @BindView(R.id.mycenter_layout_pioneercenter)
    LinearLayout mycenter_layout_pioneercenter;
    @BindView(R.id.layout_caililist)
    LinearLayout layout_caililist;
    @BindView(R.id.layout_pionorderlist)
    LinearLayout layout_pionorderlist;
    @BindView(R.id.layout_pionopenorderlist)
    LinearLayout layout_pionopenorderlist;
    ...
    @BindView(R.id.usercenter_relay_aiyou)
    LinearLayout usercenter_relay_aiyou;
    ...
    public void initView(View view) {
        ...
        layout_pionorderlist.setOnClickListener(this);
        layout_pionopenorderlist.setOnClickListener(this);
        mycenter_layout_pioneercenter.setOnClickListener(this);
        layout_pionopenauthority.setOnClickListener(this);
        layout_jintie.setOnClickListener(this);
        layout_caililist.setOnClickListener(this);
        layout_orderlist.setOnClickListener(this);
        layout_tixianrecord.setOnClickListener(this);
        usercenterRelayVolunteer.setOnClickListener(this);
        usercenterRelayDoctor.setOnClickListener(this);
        usercenter_relay_aiyou.setOnClickListener(this);
        pagetopLayoutLeft.setOnClickListener(this);
        pagetopLayoutRigth.setOnClickListener(this);
        mycenterIvHead.setOnClickListener(this);
        layout_transferrecord.setOnClickListener(this);
        layout_jiujirecord.setOnClickListener(this);
        ...
        layout_cashflow.setOnClickListener(this);
        ...
        int width = (DensityUtil.screenWith(mContext) - DensityUtil.dip2px(mContext, 40)) / 3;
        mycenter_layout_moneyjieqibao.setLayoutParams(new LinearLayout.LayoutParams(width, (int) (width * 1.227)));
        mycenter_layout_moneyfqb.setLayoutParams(new LinearLayout.LayoutParams(width, (int) (width * 1.227)));
        mycenter_layout_moneyzfb.setLayoutParams(new LinearLayout.LayoutParams(width, (int) (width * 1.227)));
    ...
    private void showFunctionGVData() {
        ...
        if (is_company_flow_pool_user != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("流水", R.id.layout_cashflow, R.mipmap.my_liushuin_icon));
        }
        ...
        FunctionGVlist1.add(new FunctionGVItemBean("我的卡包", R.id.mycenter_layout_myka, R.mipmap.my_kabao_icon));
        int isShowHelpNeedCustomer = data.getIsShowHelpNeedCustomer();
        if (isShowHelpNeedCustomer != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("救急记录", R.id.layout_jiujirecord, R.mipmap.my_jiujii_zzjl));
        }
        int isShowZhufubaoRewardCustomer = data.getIsShowZhufubaoRewardCustomer();
        if (isShowZhufubaoRewardCustomer != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("转账记录", R.id.layout_transferrecord, R.mipmap.my_icon_zhuanzhang1));
        }
        int isShowZhufubaoCustomerService = data.getIsShowZhufubaoCustomerService();
        if (isShowZhufubaoCustomerService != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("提现记录", R.id.layout_tixianrecord, R.mipmap.my_icon_tixian));
        }
        int isShowEntrepreneursConfirmCustomer = data.getIsShowEntrepreneursConfirmCustomer();
        if (isShowEntrepreneursConfirmCustomer != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("创业名额", R.id.layout_pionopenauthority, R.mipmap.my_center_piobg));
        }
        if (isShowZhufubaoRewardCustomer != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("开通创业中心打款记录", R.id.layout_pionopenorderlist, R.mipmap.my_center_piobg));
            FunctionGVlist1.add(new FunctionGVItemBean("创业中心订单", R.id.layout_pionorderlist, R.mipmap.my_center_piobg));
            FunctionGVlist1.add(new FunctionGVItemBean("财礼提现", R.id.layout_caililist, R.mipmap.my_icon_caili));
        }
        ...
        if (is_patient != 0) {
            FunctionGVlist1.add(new FunctionGVItemBean("我是爱友", R.id.usercenter_relay_aiyou, R.mipmap.my_icon_aiyou));
        }
    ...
    private void viewClick(int viewId) {
        ...
        switch (viewId) {
            ...
            case R.id.mycenter_layout_pioneercenter://创业中心
                int isShowEntrepreneursConfirmUser = data.getIsShowEntrepreneursConfirmUser();
                if (isShowEntrepreneursConfirmUser != 0) {
                    //是否创业者 1；是 0：否
                    ...
                    if (isShowEntrepreneurs == 1) {
                        ...
                        intent = new Intent(mActivity, PioneerOpenActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(intent);
                        ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                    }
                } else {
                    ToastUtils.showToast("请联系客服申请开通");
                }
                break;
            case R.id.layout_pionopenauthority:// 创业名额
                intent = new Intent(mActivity, PionOpenSetActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_pionopenorderlist://开通创业中心打款记录
                intent = new Intent(mActivity, PionOpenGMListActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_pionorderlist://创业中心订单
                intent = new Intent(mActivity, PionRewardListActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_caililist://财礼提现
                intent = new Intent(mActivity, PionCailiListActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_transferrecord://转账记录
                intent = new Intent(mActivity, RewardListActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_jiujirecord://救急记录
                intent = new Intent(mActivity, EmergencysRecordActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            case R.id.layout_tixianrecord://提现记录
                intent = new Intent(mActivity, TiXianRecordListActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
            ...
            case R.id.usercenter_relay_doctor://坐堂医
                ...
                break;
            case R.id.usercenter_relay_aiyou://我是爱友
...
//                            intent = new Intent(mActivity, RecoverCashNewActivity.class);
//                            intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
//                            startActivity(intent);
//                            ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
//                        } else {
...
//                intent.putExtra("type", "energyCenter");
//                startActivity(intent);
//                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                intent = new Intent(mActivity, UpgradeActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intent);
                ConfigUtils.getINSTANCE().setPageIntentAnim(intent, getActivity());
                break;
    ...
    private void showInfoView() {
        ...
        //1:是  ；0：不是
        IMTool.getINSTANCE().setCurrentUserInfo(user_id, user_name, avatar, false);
        if (!TextUtils.isEmpty(is_cho) && is_cho.equals("1")) {
...
//        }
    ...
    public void showRQZDialog() {
        if (mRQZDialog == null) {
            ...
            TextView tv_cancel = mRQZDialog.findViewById(R.id.tv_cancel);
            ImageView iv_xingji = mRQZDialog.findViewById(R.id.iv_xingji);
    ...
    private void setLoadData(GetHomeInfoBean mGetHomeInfoBean) {
        ...
        isOrderZhufubaoLayer = mGetHomeInfoBean.getIsOrderZhufubaoLayer();
        ...
        int isShowHelpNeedCustomer = data.getIsShowHelpNeedCustomer();
        if (isShowHelpNeedCustomer != 0) {
            layout_jiujirecord.setVisibility(View.VISIBLE);
        } else {
            layout_jiujirecord.setVisibility(View.GONE);
        }
        int isShowEntrepreneursConfirmCustomer = data.getIsShowEntrepreneursConfirmCustomer();
        if (isShowEntrepreneursConfirmCustomer != 0) {
            layout_pionopenauthority.setVisibility(View.VISIBLE);
        } else {
            layout_pionopenauthority.setVisibility(View.GONE);
        }
        int isShowZhufubaoRewardCustomer = data.getIsShowZhufubaoRewardCustomer();
        if (isShowZhufubaoRewardCustomer != 0) {
            layout_transferrecord.setVisibility(View.VISIBLE);
            layout_pionorderlist.setVisibility(View.VISIBLE);
            layout_pionopenorderlist.setVisibility(View.VISIBLE);
            layout_caililist.setVisibility(View.VISIBLE);
        } else {
            layout_transferrecord.setVisibility(View.GONE);
            layout_pionorderlist.setVisibility(View.GONE);
            layout_pionopenorderlist.setVisibility(View.GONE);
            layout_caililist.setVisibility(View.GONE);
        }
        int isShowZhufubaoCustomerService = data.getIsShowZhufubaoCustomerService();
        if (isShowZhufubaoCustomerService != 0) {
            layout_tixianrecord.setVisibility(View.VISIBLE);
        } else {
            layout_tixianrecord.setVisibility(View.GONE);
        }
        int is_company_flow_pool_user = data.getIs_company_flow_pool_user();
        if (is_company_flow_pool_user != 0) {
            layout_cashflow.setVisibility(View.VISIBLE);
        } else {
            layout_cashflow.setVisibility(View.GONE);
        }
        int is_alipay_pool_user = data.getIs_alipay_pool_user();
        if (is_alipay_pool_user != 0) {
        ...
        int is_patient = data.getIs_patient();
        if (is_patient == 0) {
            usercenter_relay_aiyou.setVisibility(View.GONE);
        } else {
            usercenter_relay_aiyou.setVisibility(View.VISIBLE);
        }
        int isPartyGroupLeader = data.getIsPartyGroupLeader();
        if (isPartyGroupLeader == 0) {
    ...
    private void gotohuzhu() {
        Intent intent = mContext.getPackageManager().getLaunchIntentForPackage("com.power.center");
        if (intent != null) {
            mContext.startActivity(intent);
        } else {
            Toast.makeText(mContext.getApplicationContext(), "哟，赶紧下载安装能量中心APP吧", Toast.LENGTH_LONG).show();
        }
    }
