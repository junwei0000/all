...
public class CalenderSelectNowUtils {
    ...
    public CalenderSelectNowUtils(Activity mContext, Handler mHandler, int mHandlerID) {
    ...
    private void setDate() {
        ...
        int yearNum = Integer.valueOf(nowyear) - yearStart + 1;
        if (yearNum < 1) {
            yearNum = 1;
        }
    ...
    public void initCurrentItem(String selectdate_) {
        ...
        Log.d("initCurrentItem", "year_c=" + year_c + "  month_c=" + month_c + "  day_c=" + day_c);
    ...
    WheelView mWheelView, mWheelViewMonth, mWheelViewDay;
    ...
    public void showDialog() {
        if (selectShengxDialog == null) {
            ...
            TextView tv_title = selectShengxDialog.findViewById(R.id.tv_title);
            TextView tv_cancel = selectShengxDialog.findViewById(R.id.tv_cancel);
            TextView tv_sure = selectShengxDialog.findViewById(R.id.tv_sure);
            mWheelView = selectShengxDialog.findViewById(R.id.mWheelView);
            mWheelViewMonth = selectShengxDialog.findViewById(R.id.mWheelViewMonth);
            mWheelViewDay = selectShengxDialog.findViewById(R.id.mWheelViewDay);
