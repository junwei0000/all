...
import com.longcheng.lifecareplan.modular.mine.doctor.doctor.activity.DocTiXianActivity;
 ...
 * 志愿者奖励
 */
public class VolRewardActivity extends BaseListActivity<VolouteerContract.View, VolouteerPresenterImp<VolouteerContract.View>> implements VolouteerContract.View {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_tixian:
                ...
                intent.putExtra("source", "2");//1坐堂医， 2志愿者
    ...
    protected void onResume() {
        super.onResume();
        mPresent.volunteerAsset();
        getList(1);
    }

    private void getList(int page) {
        mPresent.getVolRewardList(page, pageSize);
    }
    ...
    @Override
    public void AYRecordListSuccess(AYRecordListDataBean responseBean, int pageback) {
