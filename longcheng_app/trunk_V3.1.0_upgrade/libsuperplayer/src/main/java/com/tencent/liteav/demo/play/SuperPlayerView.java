...
public class SuperPlayerView extends RelativeLayout implements ITXVodPlayListener, ITXLivePlayListener {
    ...
    public TCVodControllerLarge getmVodControllerLarge() {
        return mVodControllerLarge;
    }

    public void setmVodControllerLarge(TCVodControllerLarge mVodControllerLarge) {
        this.mVodControllerLarge = mVodControllerLarge;
    }
