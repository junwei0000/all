...
public class FinishMoneyFragment extends BaseListFrag<CSRecordContract.View, CSRecordImp<CSRecordContract.View>> implements CSRecordContract.View, IActivityUpData {
    public static FinishMoneyFragment newInstance() {
        FinishMoneyFragment fragment = new FinishMoneyFragment();
        return fragment;
    }
    ...
    public int bindLayout() {
        return R.layout.fragment_finish_money;
    }
...
//                }
    ...
    private void getData(int page) {
        mPresent.helpneed_customerList(user_id, 2, page, pageSize);
    }
