...
public class MenuTopAdapter extends PagerAdapter {
    ...
    String settlementJieqiName;

    public MenuTopAdapter(Context mContext, Handler mHandler, PioneerItemBean user,
                          int receive_order_status, String displayDiffTime, int settlement_status, String settlementJieqiName) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        TextView tv_exitjieqi = view.findViewById(R.id.tv_exitjieqi);
        ...
        if (position == 0) {
            ...
            if (settlement_status == 1 && !TextUtils.isEmpty(settlementJieqiName)) {
                tv_exitjieqi.setVisibility(View.VISIBLE);
                tv_exitjieqi.setText("清算完成时间：" + settlementJieqiName);
            } else {
                tv_exitjieqi.setVisibility(View.GONE);
            }
        } else {
