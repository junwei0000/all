 ...
 * 24节气创业中心---
 */
public class PioneerAddFQBEDuActivity extends BaseActivity {
    ...
    public  static PioneerAddFQBEDuActivity mPioneerAddFQBEDuActivity;
    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.activat_relat_card:
                ...
                break;
            case R.id.btn_open:
                Intent intent = new Intent(mContext, PioneerAddFQBEDuNextActivity.class);
    ...
    public void setListener() {
        mPioneerAddFQBEDuActivity=this;
    ...
    public void initDataAfter() {
        tv_title.setText("充值1万元赠送9000祝佑宝，提升5000福祺宝额度");
        selectPayTypeView();
    }
