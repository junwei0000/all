 ...
 * 组队选择邀请用户
 */
public class ZYBUserSelectActivity extends BaseActivity {
    ...
    String zhuyoubao_team_room_id, zhuyoubao_team_item_id;
    int page;
    int page_size = 20;
    ...
    public void initDataAfter() {
        ...
        zhuyoubao_team_item_id = getIntent().getStringExtra("zhuyoubao_team_item_id");
        getOrderTeamList(1);
    }
    ...
    public void getOrderTeamList(int page_) {
        Observable<PionDaiFuDataBean> observable = Api.getInstance().service.getZybUserList(
                UserUtils.getUserId(mContext), keyword, zhuyoubao_team_room_id, page_, page_size, ExampleApplication.token);
    ...
    public void launchInvitation() {
        ...
        Observable<ResponseBean> observable = Api.getInstance().service.ZybUserlaunchInvitation(
                UserUtils.getUserId(mContext), receive_user_id, zhuyoubao_team_item_id, ExampleApplication.token);
        observable.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
