...
public class DetailJieQiAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mHolder.item_tv_jieqiname = convertView.findViewById(R.id.item_tv_jieqiname);
            mHolder.item_tv_num = convertView.findViewById(R.id.item_tv_num);
            mHolder.gv_list = convertView.findViewById(R.id.gv_list);
