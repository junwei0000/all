package com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.fqborder.adapter;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.fqborder.activity.PionBaseOrderFrag;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.fqborder.bean.PionRewardItemBean;
...
public class PionRewardListAdapter extends BaseAdapterHelper<PionRewardItemBean> {
    ViewHolder mHolder = null;
    Handler mHandler;
    Activity context;
    List<PionRewardItemBean> list;

    public PionRewardListAdapter(Activity context, List<PionRewardItemBean> list, Handler mHandler) {
        super(context, list);
    ...
    public List<PionRewardItemBean> getList() {
        return list;
    }

    public void setList(List<PionRewardItemBean> list) {
        this.list = list;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<PionRewardItemBean> list, LayoutInflater inflater) {

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.pionner_my_rewardrecord_item, parent, false);
            mHolder = new ViewHolder(convertView);
            convertView.setTag(mHolder);
        } else {
            mHolder = (ViewHolder) convertView.getTag();
        }
        PionRewardItemBean mOrderItemBean = list.get(position);
        ...
        mHolder.item_tv_num.setText(mOrderItemBean.getFuqibao());
        ...
        mHolder.item_tv_sure.setTag(mOrderItemBean.getEntrepreneurs_fuqibao_sell_order_id());
        mHolder.item_tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                message.what = PionBaseOrderFrag.SUREPAY;
                message.obj = user_zhufubao_reward_id;
                mHandler.sendMessage(message);
            }
        });
        mHolder.item_tv_cancel.setTag(mOrderItemBean.getEntrepreneurs_fuqibao_sell_order_id());
        mHolder.item_tv_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String user_zhufubao_reward_id = (String) v.getTag();
                Message message = Message.obtain();
                message.what = PionBaseOrderFrag.CANCEL;
                message.obj = user_zhufubao_reward_id;
                mHandler.sendMessage(message);
            }
        });
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            item_tv_cancel = view.findViewById(R.id.item_tv_cancel);
