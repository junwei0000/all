 ...
 * 能量中心--已打款上传凭证
 */
public class PionDaiFuConfirmActivity extends BaseListActivity<PionDFContract.View, PionDFPresenterImp<PionDFContract.View>> implements PionDFContract.View {
    ...
    public void setListener() {
        tv_montitle.setText("请选择您向用户付款的方式");
    ...
    public void RefuseSuccess(EditListDataBean responseBean) {
        ...
        PionDaiFuActivity.editOrderStatus = true;
