 ...
 * 财务管理
 */
public class FinanManageListActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    public int bindLayout() {
        return R.layout.pion_finanmange;
    }

    @Override
    public void initView(View view) {
        pageTopTvName.setText("财务管理");
    ...
    public void setListener() {
        ...
        tv_outlay.setOnClickListener(this);
    }
    ...
    private void selectPage() {
        ...
        tv_income.setTextColor(getResources().getColor(R.color.text_contents_color));
        tv_outlay.setTextColor(getResources().getColor(R.color.text_contents_color));
        if (position == 0) {
            tv_income.setTextColor(getResources().getColor(R.color.blue));
        } else if (position == 1) {
            tv_outlay.setTextColor(getResources().getColor(R.color.blue));
        }
    ...
    private void initFragment() {
        IncomeFragment mAllFragment = new IncomeFragment();
        fragmentList.add(mAllFragment);

        OutlayFragment mComingFragment = new OutlayFragment();
