...
public class BaoZhangDialogUtils {
    ...
    public void showPopupWindow() {
        if (selectDialog == null) {
            ...
            tv_jian = selectDialog.findViewById(R.id.tv_jian);
            tv_num = selectDialog.findViewById(R.id.tv_num);
            tv_add = selectDialog.findViewById(R.id.tv_add);
            btn_helpsure = selectDialog.findViewById(R.id.btn_helpsure);
            TextView tv_tishi = selectDialog.findViewById(R.id.tv_tishi);
...
//        }
    ...
    public void showDialogAsset(String help_comment_content,
        ...
        if (AssetDialog == null) {
            ...
            tv_asset = AssetDialog.findViewById(R.id.tv_asset);
            text_off = AssetDialog.findViewById(R.id.text_off);
            text_sure = AssetDialog.findViewById(R.id.text_sure);
        } else {
            AssetDialog.show();
        }
