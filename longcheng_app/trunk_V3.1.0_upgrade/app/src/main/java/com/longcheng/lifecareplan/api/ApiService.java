...
import com.longcheng.lifecareplan.bean.fupackage.FuBaoDetails;
...
import com.longcheng.lifecareplan.modular.mine.emergencys.bean.CheckNeedOrder;
...
import com.longcheng.lifecareplan.modular.mine.emergencys.bean.SubmitMoneyBean;
...
public interface ApiService {
    ...
    @GET(Config.VERSION + "blesspackage/sendBlessBagRanking")
    Observable<FuBaoRankBean> getFuBaoRankActivityList(@Query("user_id") String user_id,
                                                       @Query("type") int type,
                                                       @Query("token") String token);
    ...
    @GET(Config.VERSION + "blessbag/checkUserHave")
    Observable<ReceiveFuBaoBean> getFubaoNotReceiveList(@Query("user_id") String user_id,
                                                        @Query("token") String token);

    @FormUrlEncoded
    @POST(Config.VERSION + "blesspackage/receiveBag")
    Observable<ResponseBean> receiveBag(@Field("user_id") String user_id,
                                        @Field("bless_bag_id") String bless_bag_id,
                                        @Field("token") String token);
    ...
    // 活动已开启聚宝盆列表接口
    //
    @GET(Config.VERSION + "Jieqiactivity/activityFrozen")
    Observable<RiceActiviesListDataBean> getJieqiUserListAction(@Query("user_id") String user_id,
                                                                @Query("token") String token);

    //活动详情
    @GET(Config.VERSION + "blesspackage/avtivityInfo")
    Observable<FuBaoDetailsBeans> getHDFubaoLiveAction(@Query("user_id") String user_id,
                                                       @Query("token") String token);


    //个人福包列表接口
    @GET(Config.VERSION + "blesspackage/blessPackList")
    Observable<MyFuListBean> getFuPackageList(@Query("user_id") String user_id,
                                              @Query("type") int type,
                                              @Query("page") int page,
                                              @Query("page_size") int page_size,
                                              @Query("token") String token);
    ...
    @FormUrlEncoded
    @POST(Config.VERSION + "blesspackage/blessBagBigInfo")
    Observable<MyFuListBean> getFuPackageDetail(@Field("user_id") String user_id,
                                                @Field("bless_bag_big_id") String bless_bag_big_id,
                                                @Field("token") String token);

    //个人收到福包详情页面接口
    @GET(Config.VERSION + "cornucopia/cornucopiaGroupList")
    Observable<FuBaoDetails> receivedFupackageList(@Query("user_id") String user_id,
                                                   @Query("page") int page,
                                                   @Query("page_size") int page_size,
                                                   @Query("token") String token);
    ...
    //发送福包接口
    @GET(Config.VERSION + "blesspackage/createBlessPackage")
    Observable<ResponseBean> sendFubaoPackage(@Query("user_id") String user_id,
                                              @Query("receive_bless_json") String receive_bless_json,
                                              @Query("token") String token);

    //发送福包接口
    @FormUrlEncoded
    @POST(Config.VERSION + "blesspackage/sendBigBag")
    Observable<EditDataBean> sendFubaoPackageNew(@Field("user_id") String user_id,
                                                 @Field("bag_num") String bag_num,
                                                 @Field("token") String token);

    //领取大米活动福利接口
    @GET(Config.VERSION + "blessbag/receive")
    Observable<ResponseBean> getFubaoFuli(@Query("user_id") String user_id,
                                          @Query("address_id") String address_id,
                                          @Query("token") String token);


    //开启聚宝盆
    @GET(Config.VERSION + "blesspackage/openFrozen")
    Observable<ResponseBean> openFubaoJuBaopen(@Query("user_id") String user_id,
                                               @Query("token") String token);


    //获取通讯录数据
    @GET(Config.VERSION + "blesspackage/bookList")
    Observable<PhoneBeans> getContentUser(@Query("user_id") String user_id,
                                          @Query("token") String token);
//

    //获取通讯录数据
    @FormUrlEncoded
    @POST(Config.VERSION + "blesspackage/saveBook")
    Observable<ResponseBean> saveContentUser(@Field("user_id") String user_id,
                                             @Field("book_json") String book_json,
                                             @Field("token") String token);
}
