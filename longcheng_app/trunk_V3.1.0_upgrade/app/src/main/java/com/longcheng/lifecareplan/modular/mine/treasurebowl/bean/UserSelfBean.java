...
public class UserSelfBean {
    ...
    private int user_cornucopia_ranking_id;
    private int user_id;
    ...
    public int getUser_cornucopia_ranking_id() {
        return user_cornucopia_ranking_id;
    }

    public void setUser_cornucopia_ranking_id(int user_cornucopia_ranking_id) {
