package com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.openorder.adapter;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.openorder.activity.PionOpenGMBaseOrderFrag;
...
public class PionOpenGMListAdapter extends BaseAdapterHelper<PionOpenGMItemBean> {
    ViewHolder mHolder = null;
    Handler mHandler;
    Activity context;
    List<PionOpenGMItemBean> list;

    public PionOpenGMListAdapter(Activity context, List<PionOpenGMItemBean> list, Handler mHandler) {
        super(context, list);
    ...
    public List<PionOpenGMItemBean> getList() {
        return list;
    }

    public void setList(List<PionOpenGMItemBean> list) {
        this.list = list;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<PionOpenGMItemBean> list, LayoutInflater inflater) {
        ...
        PionOpenGMItemBean mOrderItemBean = list.get(position);
        ...
        mHolder.item_tv_sure.setTag(mOrderItemBean.getEntrepreneurs_apply_money_id());
        mHolder.item_tv_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                message.what = PionOpenGMBaseOrderFrag.SUREPAY;
        ...
        mHolder.item_tv_copy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PionOpenGMItemBean mOrderItemBean = (PionOpenGMItemBean) v.getTag();
                String cont = "打款银行信息\n"
