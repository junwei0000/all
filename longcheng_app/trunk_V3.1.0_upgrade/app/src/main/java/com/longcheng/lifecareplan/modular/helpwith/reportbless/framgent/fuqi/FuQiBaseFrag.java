package com.longcheng.lifecareplan.modular.helpwith.reportbless.framgent.fuqi;
...
public abstract class FuQiBaseFrag extends BaseListFrag<ReportContract.View, ReportPresenterImp<ReportContract.View>> implements ReportContract.View {
    ...
    private FuQiListAdapter mAdapter;

    String exponent;

    public static final int INDEX_REWARD = 0;
    public static final int INDEX_DEVOTE = 1;
    ...
    private void getList(int page) {
        mPresent.getFuQiList(user_id, getType(), page, pageSize);
    }
...
//        intent.setAction("ReportMenuActivity");
//        intent.putExtra("position", ReportMenuActivity.tab_position_fuqi);
//        intent.putExtra("fuqi_exponent", exponent);
    ...
    public void ListSuccess(ReportDataBean responseBean, int back_page) {
        ...
        if (status_.equals("400")) {
            ...
            if (mOrderAfterBean != null) {
                ...
                if (mAdapter == null) {
                    mAdapter = new FuQiListAdapter(getActivity(), mList);
