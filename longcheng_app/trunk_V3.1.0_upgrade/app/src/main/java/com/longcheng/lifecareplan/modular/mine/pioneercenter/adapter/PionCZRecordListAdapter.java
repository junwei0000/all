...
public class PionCZRecordListAdapter extends BaseAdapterHelper<PioneerItemBean> {
    ...
    public View getItemView(int position, View convertView, ViewGroup parent, List<PioneerItemBean> list, LayoutInflater inflater) {
        ...
        String source_str = mOrderItemBean.getSource_str();
        if (!TextUtils.isEmpty(source_str)) {
            mHolder.item_tv_numtype.setText(source_str);
            mHolder.item_tv_numtype.setVisibility(View.VISIBLE);
        } else {
            mHolder.item_tv_numtype.setVisibility(View.GONE);
        }
        return convertView;
    }
    ...
    private class ViewHolder {
        ...
        private TextView item_tv_numtype;
        ...
        public ViewHolder(View view) {
            ...
            item_tv_numtype = view.findViewById(R.id.item_tv_numtype);
        }
    }
}
