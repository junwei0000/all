...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.fqborder.adapter.PionRewardListAdapter;
...
public abstract class PionBaseOrderFrag extends BaseListFrag<PionRewardContract.View, PionRewardPresenterImp<PionRewardContract.View>> implements PionRewardContract.View {
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            entrepreneurs_fuqibao_sell_order_id = (String) msg.obj;
            switch (msg.what) {
                case SUREPAY:
                    setDialog(SUREPAY);
                    break;
    ...
    String entrepreneurs_fuqibao_sell_order_id;
