...
public class FuQListActivity extends BaseListActivity<ReportContract.View, ReportPresenterImp<ReportContract.View>> implements ReportContract.View {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.pagetop_layout_rigth:
                Intent intent = new Intent(mContext,FuQSynopsisActivity.class);
    ...
    public void initDataAfter() {
        ...
        if (mIMGuideUtils == null) {
            mIMGuideUtils = new IMGuideUtils(mActivity);
        }
        if (!mIMGuideUtils.getMyFuQuanGuide()) {
            mIMGuideUtils.setMyFuQuanGuide();
            mIMGuideUtils.showGuideDialog(mIMGuideUtils.FuQuan);
        }
    }
