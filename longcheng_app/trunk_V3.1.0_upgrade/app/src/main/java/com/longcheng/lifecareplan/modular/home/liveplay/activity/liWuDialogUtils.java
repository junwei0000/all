...
public class liWuDialogUtils {
    ...
    public void showPopupWindow() {
        if (selectDialog == null) {
            ...
            LinearLayout layout_bg = selectDialog.findViewById(R.id.layout_bg);
            mScrollLayout = selectDialog.findViewById(R.id.ScrollLayoutTest);
            pageControl = selectDialog.findViewById(R.id.pageControl);
            tv_allskb = selectDialog.findViewById(R.id.tv_allskb);
            TextView tv_line = selectDialog.findViewById(R.id.tv_line);
            tv_line.getBackground().setAlpha(70);
            layout_bg.getBackground().setAlpha(100);
            tv_handsel = selectDialog.findViewById(R.id.tv_handsel);
            LongClickButton tv_lower = selectDialog.findViewById(R.id.tv_lower);
            tv_num = selectDialog.findViewById(R.id.tv_num);
            LongClickButton tv_add = selectDialog.findViewById(R.id.tv_add);
