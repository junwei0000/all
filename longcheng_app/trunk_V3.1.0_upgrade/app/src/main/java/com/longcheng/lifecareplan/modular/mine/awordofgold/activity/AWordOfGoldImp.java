...
public class AWordOfGoldImp<T> extends AWordOfGoldContract.Presenter<AWordOfGoldContract.View> {
    ...
    public void newGoldWord(String userId, String token, String user_name,
                            String phone, String area_simple, String birthday,
                            String pid,String cid,String aid) {
        mView.showDialog();
        Observable<AWordOfGoldResponseBean> observable = Api.getInstance().service.getAWordOfGoldOther(
                userId, ExampleApplication.token,
