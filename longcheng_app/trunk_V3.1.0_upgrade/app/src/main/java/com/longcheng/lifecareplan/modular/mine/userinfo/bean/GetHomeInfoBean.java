...
public class GetHomeInfoBean implements Serializable {
    ...
    @SerializedName("isShowHelpNeedCustomer")
    private int isShowHelpNeedCustomer;
    ...
    private CornucopiaBean cornucopia;

    public CornucopiaBean getCornucopia() {
        return cornucopia;
    }

    public void setCornucopia(CornucopiaBean cornucopia) {
    ...
    public int getIsShowHelpNeedCustomer() {
        return isShowHelpNeedCustomer;
    }

    public void setIsShowHelpNeedCustomer(int isShowHelpNeedCustomer) {
        this.isShowHelpNeedCustomer = isShowHelpNeedCustomer;
    }
    ...
    private String showLifeBasicFestivalName;
    private int isShowLifeBasicFestival;
    private String life_basic_festival_config_id;


    private int isShowZhufubaoCustomerService;
    private int isShowZhufubaoRewardCustomer;
    private int is_company_flow_pool_user;


    private int isShowEntrepreneurs;
    private String jieqibao;
    private String fuqibao;
    private String uzhufubao;

    private int isShowEntrepreneursConfirmCustomer;//客服开通权限
    private int isShowEntrepreneursConfirmUser;//是否创业中心权限

    private int is_patient;//0：否 1：是

    private int isSettlement; // 创业导师推出状态
    ...
    public int getIsShowEntrepreneursConfirmCustomer() {
        return isShowEntrepreneursConfirmCustomer;
    }

    public void setIsShowEntrepreneursConfirmCustomer(int isShowEntrepreneursConfirmCustomer) {
        this.isShowEntrepreneursConfirmCustomer = isShowEntrepreneursConfirmCustomer;
    }

    public int getIsShowEntrepreneursConfirmUser() {
        return isShowEntrepreneursConfirmUser;
    }

    public void setIsShowEntrepreneursConfirmUser(int isShowEntrepreneursConfirmUser) {
        this.isShowEntrepreneursConfirmUser = isShowEntrepreneursConfirmUser;
    }
    ...
    public int getIsShowEntrepreneurs() {
        return isShowEntrepreneurs;
    }

    public void setIsShowEntrepreneurs(int isShowEntrepreneurs) {
        this.isShowEntrepreneurs = isShowEntrepreneurs;
    }

    public int getIs_company_flow_pool_user() {
        return is_company_flow_pool_user;
    }

    public void setIs_company_flow_pool_user(int is_company_flow_pool_user) {
        this.is_company_flow_pool_user = is_company_flow_pool_user;
    }

    public int getIsShowZhufubaoRewardCustomer() {
        return isShowZhufubaoRewardCustomer;
    }

    public void setIsShowZhufubaoRewardCustomer(int isShowZhufubaoRewardCustomer) {
        this.isShowZhufubaoRewardCustomer = isShowZhufubaoRewardCustomer;
    }

    public int getIsShowZhufubaoCustomerService() {
        return isShowZhufubaoCustomerService;
    }

    public void setIsShowZhufubaoCustomerService(int isShowZhufubaoCustomerService) {
        this.isShowZhufubaoCustomerService = isShowZhufubaoCustomerService;
    }

    public String getLife_basic_festival_config_id() {
        return life_basic_festival_config_id;
    }

    public void setLife_basic_festival_config_id(String life_basic_festival_config_id) {
        this.life_basic_festival_config_id = life_basic_festival_config_id;
    }

    public String getShowLifeBasicFestivalName() {
        return showLifeBasicFestivalName;
    }

    public void setShowLifeBasicFestivalName(String showLifeBasicFestivalName) {
        this.showLifeBasicFestivalName = showLifeBasicFestivalName;
    }

    public int getIsShowLifeBasicFestival() {
        return isShowLifeBasicFestival;
    }

    public void setIsShowLifeBasicFestival(int isShowLifeBasicFestival) {
        this.isShowLifeBasicFestival = isShowLifeBasicFestival;
    }
    ...
    public void setIsBlessedTeacher(int isBlessedTeacher) {
        this.isBlessedTeacher = isBlessedTeacher;
    }
    ...
    public class CornucopiaBean {


        /**
         * is_open_cornucopia : 0
         * super_shoukangyuan : 0
         */

        private int is_open_cornucopia;
        private int super_shoukangyuan;

        public int getIs_open_cornucopia() {
            return is_open_cornucopia;
        }

        public void setIs_open_cornucopia(int is_open_cornucopia) {
            this.is_open_cornucopia = is_open_cornucopia;
        }
