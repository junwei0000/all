...
public class OrderListAdapter extends BaseAdapterHelper<OrderItemBean> {
        ...
        if (top_status == 3) {
            ...
            if (type == 1) {
                ...
                if (top_status == 1) {//进行中加进度显示
                    showcon = mOrderItemBean.getTop_title();
                }
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            tv_goodtype = view.findViewById(R.id.tv_goodtype);
            tv_status = view.findViewById(R.id.tv_status);
            item_iv_status = view.findViewById(R.id.item_iv_status);
            item_iv_goodthumb = view.findViewById(R.id.item_iv_goodthumb);
            item_tv_goodname = view.findViewById(R.id.item_tv_goodname);
            item_iv_goodtypeimg = view.findViewById(R.id.item_iv_goodtypeimg);
            item_tv_goodnum = view.findViewById(R.id.item_tv_goodnum);
            item_tv_date = view.findViewById(R.id.item_tv_date);
            item_tv_left = view.findViewById(R.id.item_tv_left);
            item_tv_center = view.findViewById(R.id.item_tv_center);
            item_tv_right = view.findViewById(R.id.item_tv_right);
        }
    }
}
