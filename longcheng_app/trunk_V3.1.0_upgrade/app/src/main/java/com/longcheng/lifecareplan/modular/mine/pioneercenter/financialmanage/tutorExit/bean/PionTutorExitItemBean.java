...
public class PionTutorExitItemBean implements Serializable {
    private int position;
    private String entrepreneurs_settlement_order_id;
    ...
    public String getEntrepreneurs_settlement_order_id() {
        return entrepreneurs_settlement_order_id;
    }

    public void setEntrepreneurs_settlement_order_id(String entrepreneurs_settlement_order_id) {
        this.entrepreneurs_settlement_order_id = entrepreneurs_settlement_order_id;
    }
