 ...
 * 24节气创业中心---升级
 */
public class PioneerAddFQBEDuNextActivity extends BaseActivity {
    ...
    public void setListener() {
        pageTopTvName.setText("升级24节气创业中心");
    ...
    public void getZYBBalanceInfo() {
        showDialog();
        Observable<ZYBBDataBean> observable = Api.getInstance().service.getupgradeBankInfo(
    ...
    private void applyPay() {
        ...
        showDialog();
        Observable<PayWXDataBean> observable = Api.getInstance().service.PiondoUpgradePay(UserUtils.getUserId(mContext),
    ...
    private void applyPaySuccuess() {
        ...
        PioneerAddFQBEDuActivity.mPioneerAddFQBEDuActivity.doFinish();
        doFinish();
    }
