...
public class GaveQuliRecordAdapter extends BaseAdapterHelper<PionZFBSelectDataBean.PionZFBSBean> {
    ViewHolder mHolder = null;
    Context context;
    int topindex;

    public GaveQuliRecordAdapter(Context context, List<PionZFBSelectDataBean.PionZFBSBean> list) {
        super(context, list);
    ...
    public View getItemView(int position, View convertView, ViewGroup parent, List<PionZFBSelectDataBean.PionZFBSBean> list, LayoutInflater inflater) {
        ...
        mHolder.item_tv_add.setVisibility(View.GONE);
        return convertView;
    }
