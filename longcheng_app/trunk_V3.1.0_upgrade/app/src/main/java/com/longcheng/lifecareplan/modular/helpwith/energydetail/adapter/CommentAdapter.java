...
public class CommentAdapter extends BaseAdapterHelper<DetailItemBean> {
    ...
    public CommentAdapter(Context context, List<DetailItemBean> list, Handler mHandler) {
        super(context, list);
    ...
    public View getItemView(int position, View convertView, ViewGroup parent, List<DetailItemBean> list, LayoutInflater inflater) {
        ...
        DetailItemBean mItemBean = list.get(position);
        ...
        mHolder.item_iv_pinglun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DetailItemBean mItemBean = (DetailItemBean) v.getTag();
        ...
        List<DetailItemBean> replay_comments = mItemBean.getReplay_comments();
        ...
        if (replay_comments != null && replay_comments.size() > 0) {
            ...
            for (DetailItemBean mDetailItemBean : replay_comments) {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            item_iv_arrow = view.findViewById(R.id.item_iv_arrow);
            ...
            item_tv_deseribe = view.findViewById(R.id.item_tv_deseribe);
            item_tv_time = view.findViewById(R.id.item_tv_time);
            item_iv_pinglun = view.findViewById(R.id.item_iv_pinglun);
            item_layout_huifu = view.findViewById(R.id.item_layout_huifu);
        }
    }
}
