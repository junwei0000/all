...
public class DocListAdapter extends BaseAdapterHelper<AYApplyListAfterBean.BasicItemBean> {
    ViewHolder mHolder = null;
    Activity context;
    List<AYApplyListAfterBean.BasicItemBean> list;

    public DocListAdapter(Activity context, List<AYApplyListAfterBean.BasicItemBean> list) {
        super(context, list);
