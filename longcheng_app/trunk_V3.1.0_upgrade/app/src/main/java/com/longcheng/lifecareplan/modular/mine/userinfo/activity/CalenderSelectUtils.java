...
public class CalenderSelectUtils {
    ...
    public void showDialog() {
        if (selectShengxDialog == null) {
            ...
            WheelView mWheelView = selectShengxDialog.findViewById(R.id.mWheelView);
            WheelView mWheelViewMonth = selectShengxDialog.findViewById(R.id.mWheelViewMonth);
            WheelView mWheelViewDay = selectShengxDialog.findViewById(R.id.mWheelViewDay);
            tv_title.setText("");
