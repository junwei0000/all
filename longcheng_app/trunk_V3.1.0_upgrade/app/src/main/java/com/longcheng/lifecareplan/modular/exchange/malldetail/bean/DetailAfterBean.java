...
public class DetailAfterBean {
    ...
    int noBuyJieqiactivityStatus;
    String noBuyJieqiactivityMsg;


    public int getNoBuyJieqiactivityStatus() {
        return noBuyJieqiactivityStatus;
    }

    public void setNoBuyJieqiactivityStatus(int noBuyJieqiactivityStatus) {
        this.noBuyJieqiactivityStatus = noBuyJieqiactivityStatus;
    }

    public String getNoBuyJieqiactivityMsg() {
        return noBuyJieqiactivityMsg;
    }

    public void setNoBuyJieqiactivityMsg(String noBuyJieqiactivityMsg) {
        this.noBuyJieqiactivityMsg = noBuyJieqiactivityMsg;
    }
