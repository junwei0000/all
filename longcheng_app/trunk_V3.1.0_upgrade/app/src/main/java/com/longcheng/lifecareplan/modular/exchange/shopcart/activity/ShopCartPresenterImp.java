...
public class ShopCartPresenterImp<T> extends ShopCartContract.Presenter<ShopCartContract.View> {
     ...
     * @author MarkShuai
     */
    public void submitGoodsOrder(String user_id, String address_id, String total_skb_price,
                                 String total_super_ability, String orders_datas,String carving) {
        mView.showDialog();
        Observable<EditListDataBean> observable = Api.getInstance().service.submitGoodsOrder(user_id, address_id,
                total_skb_price, total_super_ability, orders_datas,carving, ExampleApplication.token);
