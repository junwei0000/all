...
public class DensityUtil {
     ...
     * @return
     */
    public static Bitmap getAssets(Activity activity, String fileName) {
        Bitmap bitmap = null;
        AssetManager assetManager = activity.getResources().getAssets();
        try {
            InputStream inputStream = assetManager.open("solar24/" + fileName + ".png");
     ...
     * @return
     */
    public static Bitmap getAssetsNew(Activity activity, String fileName) {
        Bitmap bitmap = null;
        AssetManager assetManager = activity.getResources().getAssets();
        try {
    ...
    public static void getPhoneToKey(Context context, String tel) {
        String tel_ = tel;
        if (!TextUtils.isEmpty(tel_)) {
            if (!tel_.contains("tel:")) {
                tel_ = "tel:" + tel;
            }
