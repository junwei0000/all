...
public class ZFBSelectAdapter extends BaseAdapterHelper<PionZFBSelectDataBean.PionZFBSBean> {
    ViewHolder mHolder = null;
    Context context;
    int topindex;
    public ZFBSelectAdapter(Context context, List<PionZFBSelectDataBean.PionZFBSBean> list) {
        super(context, list);
