...
/**
 * 创业中心1：开通 2：续费 3:升级-客服处理
 */
public class PionOpenListActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    public static int type_xufei=2;
    public static int type_upgrade=3;
    ...
    public void setListener() {
        ...
        if(type==type_open){
            pageTopTvName.setText("创业中心开通");
        }else if(type==type_xufei){
            pageTopTvName.setText("创业中心续费");
        }else if(type==type_upgrade){
            pageTopTvName.setText("创业中心升级");
        }
    }
