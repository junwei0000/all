...
public class UpLoadDialogUtils {
    ...
    public void setShareDialog(String cover_url, String name, String title, String codeurl) {
        ...
        if (codeDialog == null) {
            ...
            iv_cover = codeDialog.findViewById(R.id.iv_cover);
            tv_name = codeDialog.findViewById(R.id.tv_name);
            tv_cont = codeDialog.findViewById(R.id.tv_cont);
            iv_code = codeDialog.findViewById(R.id.iv_code);
            ImageButton iv_btn = codeDialog.findViewById(R.id.iv_btn);
            pop_layout = codeDialog.findViewById(R.id.pop_layout);
            RelativeLayout relat_cover = codeDialog.findViewById(R.id.relat_cover);
            relat_cover.setLayoutParams(new LinearLayout.LayoutParams(p.width, (int) (p.width * 1.2)));
            TextView tv_save = codeDialog.findViewById(R.id.tv_save);
    ...
    public void setDialog(String video_user_id) {
        if (selectDialog == null) {
            ...
            TextView tv_download = selectDialog.findViewById(R.id.tv_download);
            tv_del = selectDialog.findViewById(R.id.tv_del);
            TextView tv_share = selectDialog.findViewById(R.id.tv_share);
