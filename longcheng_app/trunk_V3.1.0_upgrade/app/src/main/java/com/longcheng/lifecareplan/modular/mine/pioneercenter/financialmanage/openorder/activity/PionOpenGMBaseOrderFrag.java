...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.openorder.adapter.PionOpenGMListAdapter;
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.openorder.bean.PionOpenGMItemBean;
...
public abstract class PionOpenGMBaseOrderFrag extends BaseListFrag<PionOpenGMContract.View, PionOpenGMPresenterImp<PionOpenGMContract.View>> implements PionOpenGMContract.View {
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            entrepreneurs_apply_money_id = (String) msg.obj;
            switch (msg.what) {
                case SUREPAY:
                    setDialog(SUREPAY);
                    break;
    ...
    String entrepreneurs_apply_money_id;
