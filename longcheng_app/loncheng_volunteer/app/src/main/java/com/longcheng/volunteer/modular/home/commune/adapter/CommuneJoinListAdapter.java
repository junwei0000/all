...
import com.longcheng.volunteer.modular.home.commune.activity.CommuneJoinTeamListActivity;
...
import com.longcheng.volunteer.utils.like.GoodImgView;
...
public class CommuneJoinListAdapter extends BaseAdapterHelper<CommuneItemBean> {
    ...
    private class ViewHolder {
        ...
        public ViewHolder(View view) {
            item_layout_top = (LinearLayout) view.findViewById(R.id.item_layout_top);
            item_iv_communethumb = (ImageView) view.findViewById(R.id.item_iv_communethumb);
            item_layout_likenum = (LinearLayout) view.findViewById(R.id.item_layout_likenum);
            item_tv_likenum = (TextView) view.findViewById(R.id.item_tv_likenum);
            item_tv_communename = (TextView) view.findViewById(R.id.item_tv_communename);
            item_tv_communename2 = (TextView) view.findViewById(R.id.item_tv_communename2);

            item_tv_num = (TextView) view.findViewById(R.id.item_tv_num);
            item_tv_engrynum = (TextView) view.findViewById(R.id.item_tv_engrynum);

            item_tv_joincommune = (TextView) view.findViewById(R.id.item_tv_joincommune);
        }
    }
}
