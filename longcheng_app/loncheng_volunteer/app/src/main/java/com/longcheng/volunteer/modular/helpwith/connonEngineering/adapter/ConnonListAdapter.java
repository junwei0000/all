package com.longcheng.volunteer.modular.helpwith.connonEngineering.adapter;
...
import com.longcheng.volunteer.modular.helpwith.connonEngineering.bean.ConnonItemBean;
...
public class ConnonListAdapter extends BaseAdapterHelper<ConnonItemBean> {
    ViewHolder mHolder = null;
    Context context;

    public ConnonListAdapter(Context context, List<ConnonItemBean> list) {
        super(context, list);
        this.context = context;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<ConnonItemBean> list, LayoutInflater inflater) {
        ...
        ConnonItemBean mHelpItemBean = list.get(position);
