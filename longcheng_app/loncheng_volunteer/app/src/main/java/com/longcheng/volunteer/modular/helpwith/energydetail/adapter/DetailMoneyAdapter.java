...
public class DetailMoneyAdapter extends BaseAdapter {
    ...
    public DetailMoneyAdapter(Context context, List<DetailItemBean> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mHolder.item_tv_moneyimg = (ImageView) convertView.findViewById(R.id.item_tv_moneyimg);
        ...
        if (is_applying_help > 0 && mutual_help_money > mEnergyItemBean.getMoney()) {
