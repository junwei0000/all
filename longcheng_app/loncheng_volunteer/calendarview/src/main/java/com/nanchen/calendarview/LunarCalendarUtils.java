...
public class LunarCalendarUtils {
     ...
     **/
    final static String[] lunarHoliday = new String[]{"0101 春节", "0115 元宵节", "0505 端午节", "0707 七夕情人节",
     ...
     * @return
     */
    public String getLunarDateYYYY(int year_log, int month_log, int day_log,
                                   boolean isday) {
...
//        else
//            return getChinaDayString(day);
        return "农历" + numberToChinese(year) + "年" + chineseNumber[month - 1] + "月" + getChinaDayString(day);
    }
    ...
    public static void main(String[] args) {
        System.out.println(new LunarCalendarUtils().getLunarDate(2018, 9, 10, false));
    }
     ...
     * @return
     */
    public String sectionTrans(int section) {
