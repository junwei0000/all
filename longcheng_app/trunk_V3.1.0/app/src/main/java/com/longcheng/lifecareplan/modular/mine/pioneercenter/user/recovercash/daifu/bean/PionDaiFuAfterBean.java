...
public class PionDaiFuAfterBean {
    ...
    SelectItemBean room;
    private List<SelectItemBean> users;
    private List<SelectItemBean> record;
    int num;
    ...
    public List<SelectItemBean> getRecord() {
        return record;
    }

    public void setRecord(List<SelectItemBean> record) {
        this.record = record;
    }

    public SelectItemBean getRoom() {
        return room;
    }

    public void setRoom(SelectItemBean room) {
        this.room = room;
    }

    public List<SelectItemBean> getUsers() {
        return users;
    }

    public void setUsers(List<SelectItemBean> users) {
        this.users = users;
    }
