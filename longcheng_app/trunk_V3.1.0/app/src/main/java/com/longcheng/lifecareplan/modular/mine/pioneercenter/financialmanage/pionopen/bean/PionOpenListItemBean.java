...
public class PionOpenListItemBean implements Serializable {
    private int position;
    private String entrepreneurs_order_id;
    ...
    public String getEntrepreneurs_order_id() {
        return entrepreneurs_order_id;
    }

    public void setEntrepreneurs_order_id(String entrepreneurs_order_id) {
        this.entrepreneurs_order_id = entrepreneurs_order_id;
    }
