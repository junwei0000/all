...
public class ZuDuiSelectAdapter extends BaseAdapterHelper<SelectItemBean> {
    ViewHolder mHolder = null;
    Context context;

    public ZuDuiSelectAdapter(Context context, List<SelectItemBean> list) {
        super(context, list);
    ...
    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<SelectItemBean> list, LayoutInflater inflater) {
        if (convertView == null) {
        ...
        SelectItemBean mDaiFuItemBean = list.get(position);
        ...
        if (mDaiFuItemBean.getShowSelect() == 1) {
