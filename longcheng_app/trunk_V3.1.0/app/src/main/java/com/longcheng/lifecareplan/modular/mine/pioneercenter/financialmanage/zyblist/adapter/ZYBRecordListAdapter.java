package com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.zyblist.adapter;
...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.financialmanage.zyblist.activity.ZYBRecordBaseOrderFrag;
...
public class ZYBRecordListAdapter extends BaseAdapterHelper<ZYBRecordItemBean> {
    ViewHolder mHolder = null;
    Handler mHandler;
    Activity context;
    List<ZYBRecordItemBean> list;

    public ZYBRecordListAdapter(Activity context, List<ZYBRecordItemBean> list, Handler mHandler) {
        super(context, list);
    ...
    public List<ZYBRecordItemBean> getList() {
        return list;
    }

    public void setList(List<ZYBRecordItemBean> list) {
        this.list = list;
    }

    @Override
    public View getItemView(int position, View convertView, ViewGroup parent, List<ZYBRecordItemBean> list, LayoutInflater inflater) {
        ...
        ZYBRecordItemBean mOrderItemBean = list.get(position);
        ...
        mHolder.item_tv_sure.setTag(mOrderItemBean.getEntrepreneurs_zhufubao_buy_order_id());
        mHolder.item_tv_sure.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String entrepreneurs_zhufubao_buy_order_id = (String) v.getTag();
                Message message = Message.obtain();
                message.what = ZYBRecordBaseOrderFrag.SUREPAY;
                message.obj = entrepreneurs_zhufubao_buy_order_id;
