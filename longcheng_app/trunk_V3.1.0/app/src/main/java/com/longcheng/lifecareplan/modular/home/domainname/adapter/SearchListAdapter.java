...
public class SearchListAdapter extends BaseAdapterHelper<HotListDataBean.HotItemInfo> {
    ViewHolder mHolder = null;
    Activity context;

    int level;
    Handler mHandler;
    public SearchListAdapter(Activity context, List<HotListDataBean.HotItemInfo> list, int level, Handler mHandler) {
        super(context, list);
