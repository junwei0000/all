...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //中间进度显示的字体大小
        mTextSize = typedArray.getDimension(R.styleable.RoundProgressBar_RoundtextSize, 15);

        //最大值
        mMax = typedArray.getInteger(R.styleable.RoundProgressBar_max2, 100);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mStyle) {
            ...
            case FILL:
                ...
                //画圆弧
                if (mProgress != 0) {
                    canvas.drawArc(oval, 270, 360 * mProgress / mMax, true, mPaint);
                }
                break;
        }
