 ...
 * 提现--已收款上传凭证
 */
public class PionCZConfirmActivity extends BaseListActivity<PionDCContract.View, PionDCPresenterImp<PionDCContract.View>> implements PionDCContract.View {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_givemoney:
                if (!TextUtils.isEmpty(bless_payment_photo)) {
                    if (!requestStatus) {
                        requestStatus = true;
                        mPresent.updateOrderStatus(user_zhufubao_order_id, 1, bless_payment_channel, bless_payment_photo);
                    }
                } else {
    ...
    public void setListener() {
        ...
        btnGivemoney.setText("确定已付款");
        tv_montitle.setText("请选择您向对方付款的方式");
    ...
    public void RefuseSuccess(ResponseBean responseBean) {
        ...
        PionCZRecordActivity.editOrderStatus = true;
