...
public class PionDaiCAdapter extends BaseAdapterHelper<PionDaiCItemBean> {
    ...
    public View getItemView(int position, View convertView, ViewGroup parent, List<PionDaiCItemBean> list, LayoutInflater inflater) {
        ...
        if (is_group_order == 1) {
            ...
            mHolder.item_layout_zybleader.setVisibility(View.VISIBLE);
            GlideDownLoadImage.getInstance().loadCircleImage(mDaiFuItemBean.getTeam_leader_avatar(), mHolder.item_iv_imgleader);
            String leadernames = CommonUtil.setName(mDaiFuItemBean.getTeam_leader_user_name());
            mHolder.item_tv_nameleader.setText(leadernames);
            mHolder.item_tv_phoneleader.setText(mDaiFuItemBean.getTeam_leader_phone());
        } else {
            mHolder.item_tv_grouptype.setVisibility(View.GONE);
            mHolder.item_layout_zybleader.setVisibility(View.GONE);
        }
    ...
    private class ViewHolder {
        ...
        private LinearLayout item_layout_zybleader;
        private ImageView item_iv_imgleader;
        private TextView item_tv_nameleader;
        private TextView item_tv_phoneleader;
        ...
        public ViewHolder(View convertView) {
            ...
            item_layout_zybleader = convertView.findViewById(R.id.item_layout_zybleader);
            item_iv_imgleader = convertView.findViewById(R.id.item_iv_imgleader);
            item_tv_nameleader = convertView.findViewById(R.id.item_tv_nameleader);
            item_tv_phoneleader = convertView.findViewById(R.id.item_tv_phoneleader);
        }
    }
}
