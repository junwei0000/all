package com.longcheng.lifecareplan.modular.home.liveplay.shortvideo.edit;
    ...
    private void setTouchProcessListener() {
        mStartViewTouchProcess.setOnPositionChangedListener(new ViewTouchProcess.OnPositionChangedListener() {
            ...
            public void onPostionChanged(float distance) {
                ...
                TXCLog.d(TAG, String.format(Locale.getDefault(), "onPostionChanged, mStartView distance = %f, dtime = %d", distance, dtime));
