...
import com.longcheng.lifecareplan.modular.mine.pioneercenter.adapter.PionCZRecordListAdapter;
 ...
 * 福祺宝攻略-充值记录
 */
public class PionFQBGLRecordActivity extends BaseListActivity<PioneerContract.View, PioneerPresenterImp<PioneerContract.View>> implements PioneerContract.View {
    ...
    TextView tvAllnum;
    @BindView(R.id.layout_fqbgl)
    LinearLayout layoutFqbgl;
    ...
    public void setListener() {
        pageTopTvName.setText("充值记录");
        notDateCont.setText("暂无充值记录");
    ...
    public void initDataAfter() {
        layoutFqbgl.setVisibility(View.VISIBLE);
        getList(1);
    }

    private void getList(int page) {
        mPresent.rewardRechargeMoneyRecordList(page, pageSize);
    }
    ...
    PionCZRecordListAdapter mAdapter;
    ...
    public void CZListSuccess(PioneerDataBean responseBean, int backPage) {
        ...
        if (status.equals("400")) {
            ...
            tvAllnum.setText(responseBean.getData().getTotal_money());
            ArrayList<PioneerItemBean> helpList = responseBean.getData().getRecords();
            ...
            if (mAdapter == null) {
                mAdapter = new PionCZRecordListAdapter(mActivity, helpList);
