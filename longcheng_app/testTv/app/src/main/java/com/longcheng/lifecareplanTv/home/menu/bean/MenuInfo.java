package com.longcheng.lifecareplanTv.home.menu.bean;
...
public class MenuInfo implements Serializable {
    ...
    public MenuInfo(String jieqiname, String huaname, String nextday, int bgImgId, int iconId, String iconname) {
