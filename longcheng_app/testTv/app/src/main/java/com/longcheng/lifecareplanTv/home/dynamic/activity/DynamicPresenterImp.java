...
public class DynamicPresenterImp<T> extends DynamicContract.Presenter<DynamicContract.View> {

    private Activity mContext;
    private DynamicContract.View mView;

    public DynamicPresenterImp(Activity mContext, DynamicContract.View mView) {
