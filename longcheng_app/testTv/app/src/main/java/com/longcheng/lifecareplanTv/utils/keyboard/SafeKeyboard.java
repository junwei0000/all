package com.longcheng.lifecareplanTv.utils.keyboard;
...
public class SafeKeyboard {
    ...
    /**
     * 键盘类型: 1 字母；2当前是符号键盘；3 数字
     */
    private int keyboardType = 3;
    ...
    public void setmEditText(EditText mEditText) {
        ...
        addListeners(mEditText);
    }

    public SafeKeyboard(Context mContext, LinearLayout layout) {
        this.mContext = mContext;
        this.layout = layout;

        this.keyboardContainerResId = R.layout.keyboard_containor;
        @SuppressLint("InflateParams")
        View view = LayoutInflater.from(mContext).inflate(keyboardContainerResId, null);
        ...
        delDrawable = mContext.getResources().getDrawable(R.mipmap.icon_del);
        keyboardView.setDelDrawable(delDrawable);
        this.lowDrawable = mContext.getResources().getDrawable(R.mipmap.icon_capital_default);
        keyboardView.setLowDrawable(lowDrawable);
        this.upDrawable = mContext.getResources().getDrawable(R.mipmap.icon_capital_selected);
    ...
    private void initKeyboard() {
        ...
        keyboardView.setLowDrawable(lowDrawable);
        keyboardView.setUpDrawable(upDrawable);
        setKeyboardType(keyboardType);                     //给键盘View设置键盘
