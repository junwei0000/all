 ...
 */
public class TvRecyclerViewList extends RecyclerView {
    ...
    public TvRecyclerViewList(Context context) {
        this(context, null);
    }

    public TvRecyclerViewList(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public TvRecyclerViewList(Context context, AttributeSet attrs, int defStyle) {
