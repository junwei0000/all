package com.longcheng.lifecareplan.home.picture.adapter;
...
public class PictureAdapter extends BaseRecyclerAdapter<BaseRecyclerViewHolder, SearchResultModel> {
    ...
    public PictureAdapter(Context context, TvRecyclerView recyclerView, GridLayoutManager layoutManager, List<SearchResultModel> dataList) {
