...
import com.ricky.nfc.activity.ReadOpenActivity;
...
import com.ricky.nfc.activity.WriteOpenAppActivity;
    ...
    private void switchActivity(int position) {
        switch (position) {
            ...
            case 7: //写NFC标签非NDEF格式的数据
                ...
                break;
            case 8: //写入打开app
                startActivity(new Intent(this, WriteOpenAppActivity.class));
                break;
            case 9:
                break;
            default:
